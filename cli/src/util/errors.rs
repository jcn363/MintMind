...
// When the provided connection token doesn't match the one used to set up the original MintMind Server
...
// When the MintMind server has an unrecognized extension (rather than zip or gz)
#[derive(Debug)]
...
/// Internal errors in the MintMind CLI.
