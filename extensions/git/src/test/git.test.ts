beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/git/src/test/git.test.ts, window: extensions/git/src/test/git.test.ts, workspace: extensions/git/src/test/git.test.ts, ExtensionContext: class extensions/git/src/test/git.test.ts, commands: extensions/git/src/test/git.test.ts }; });
/*---------------------------------------------------------------------------------------------
