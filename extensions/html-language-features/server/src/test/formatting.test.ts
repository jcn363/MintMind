beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/html-language-features/server/src/test/formatting.test.ts, window: extensions/html-language-features/server/src/test/formatting.test.ts, workspace: extensions/html-language-features/server/src/test/formatting.test.ts, ExtensionContext: class extensions/html-language-features/server/src/test/formatting.test.ts, commands: extensions/html-language-features/server/src/test/formatting.test.ts }; });
/*---------------------------------------------------------------------------------------------
