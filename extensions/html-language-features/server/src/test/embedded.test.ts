beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/html-language-features/server/src/test/embedded.test.ts, window: extensions/html-language-features/server/src/test/embedded.test.ts, workspace: extensions/html-language-features/server/src/test/embedded.test.ts, ExtensionContext: class extensions/html-language-features/server/src/test/embedded.test.ts, commands: extensions/html-language-features/server/src/test/embedded.test.ts }; });
/*---------------------------------------------------------------------------------------------
