beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/html-language-features/server/src/test/words.test.ts, window: extensions/html-language-features/server/src/test/words.test.ts, workspace: extensions/html-language-features/server/src/test/words.test.ts, ExtensionContext: class extensions/html-language-features/server/src/test/words.test.ts, commands: extensions/html-language-features/server/src/test/words.test.ts }; });
/*---------------------------------------------------------------------------------------------
