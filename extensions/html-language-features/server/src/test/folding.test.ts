beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/html-language-features/server/src/test/folding.test.ts, window: extensions/html-language-features/server/src/test/folding.test.ts, workspace: extensions/html-language-features/server/src/test/folding.test.ts, ExtensionContext: class extensions/html-language-features/server/src/test/folding.test.ts, commands: extensions/html-language-features/server/src/test/folding.test.ts }; });
/*---------------------------------------------------------------------------------------------
