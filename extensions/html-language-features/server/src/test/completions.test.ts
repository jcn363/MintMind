beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/html-language-features/server/src/test/completions.test.ts, window: extensions/html-language-features/server/src/test/completions.test.ts, workspace: extensions/html-language-features/server/src/test/completions.test.ts, ExtensionContext: class extensions/html-language-features/server/src/test/completions.test.ts, commands: extensions/html-language-features/server/src/test/completions.test.ts }; });
/*---------------------------------------------------------------------------------------------
