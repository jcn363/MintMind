beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/html-language-features/server/src/test/rename.test.ts, window: extensions/html-language-features/server/src/test/rename.test.ts, workspace: extensions/html-language-features/server/src/test/rename.test.ts, ExtensionContext: class extensions/html-language-features/server/src/test/rename.test.ts, commands: extensions/html-language-features/server/src/test/rename.test.ts }; });
/*---------------------------------------------------------------------------------------------
