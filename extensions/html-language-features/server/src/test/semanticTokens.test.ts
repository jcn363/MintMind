beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/html-language-features/server/src/test/semanticTokens.test.ts, window: extensions/html-language-features/server/src/test/semanticTokens.test.ts, workspace: extensions/html-language-features/server/src/test/semanticTokens.test.ts, ExtensionContext: class extensions/html-language-features/server/src/test/semanticTokens.test.ts, commands: extensions/html-language-features/server/src/test/semanticTokens.test.ts }; });
/*---------------------------------------------------------------------------------------------
