...
beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/ipynb/src/test/clearOutputs.test.ts, window: extensions/ipynb/src/test/clearOutputs.test.ts, workspace: extensions/ipynb/src/test/clearOutputs.test.ts, ExtensionContext: class extensions/ipynb/src/test/clearOutputs.test.ts, commands: extensions/ipynb/src/test/clearOutputs.test.ts }; });
/*---------------------------------------------------------------------------------------------
