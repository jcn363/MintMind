...
beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/ipynb/src/test/notebookModelStoreSync.test.ts, window: extensions/ipynb/src/test/notebookModelStoreSync.test.ts, workspace: extensions/ipynb/src/test/notebookModelStoreSync.test.ts, ExtensionContext: class extensions/ipynb/src/test/notebookModelStoreSync.test.ts, commands: extensions/ipynb/src/test/notebookModelStoreSync.test.ts }; });
/*---------------------------------------------------------------------------------------------
