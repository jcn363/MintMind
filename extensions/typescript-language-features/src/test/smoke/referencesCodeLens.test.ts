beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/typescript-language-features/src/test/smoke/referencesCodeLens.test.ts, window: extensions/typescript-language-features/src/test/smoke/referencesCodeLens.test.ts, workspace: extensions/typescript-language-features/src/test/smoke/referencesCodeLens.test.ts, ExtensionContext: class extensions/typescript-language-features/src/test/smoke/referencesCodeLens.test.ts, commands: extensions/typescript-language-features/src/test/smoke/referencesCodeLens.test.ts }; });
/*---------------------------------------------------------------------------------------------
