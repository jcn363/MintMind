beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/typescript-language-features/src/test/smoke/fixAll.test.ts, window: extensions/typescript-language-features/src/test/smoke/fixAll.test.ts, workspace: extensions/typescript-language-features/src/test/smoke/fixAll.test.ts, ExtensionContext: class extensions/typescript-language-features/src/test/smoke/fixAll.test.ts, commands: extensions/typescript-language-features/src/test/smoke/fixAll.test.ts }; });
/*---------------------------------------------------------------------------------------------
