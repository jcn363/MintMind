beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/typescript-language-features/src/test/smoke/completions.test.ts, window: extensions/typescript-language-features/src/test/smoke/completions.test.ts, workspace: extensions/typescript-language-features/src/test/smoke/completions.test.ts, ExtensionContext: class extensions/typescript-language-features/src/test/smoke/completions.test.ts, commands: extensions/typescript-language-features/src/test/smoke/completions.test.ts }; });
/*---------------------------------------------------------------------------------------------
