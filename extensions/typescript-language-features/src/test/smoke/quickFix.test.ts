beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/typescript-language-features/src/test/smoke/quickFix.test.ts, window: extensions/typescript-language-features/src/test/smoke/quickFix.test.ts, workspace: extensions/typescript-language-features/src/test/smoke/quickFix.test.ts, ExtensionContext: class extensions/typescript-language-features/src/test/smoke/quickFix.test.ts, commands: extensions/typescript-language-features/src/test/smoke/quickFix.test.ts }; });
/*---------------------------------------------------------------------------------------------
