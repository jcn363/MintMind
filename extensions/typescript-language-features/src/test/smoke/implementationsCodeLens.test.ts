beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/typescript-language-features/src/test/smoke/implementationsCodeLens.test.ts, window: extensions/typescript-language-features/src/test/smoke/implementationsCodeLens.test.ts, workspace: extensions/typescript-language-features/src/test/smoke/implementationsCodeLens.test.ts, ExtensionContext: class extensions/typescript-language-features/src/test/smoke/implementationsCodeLens.test.ts, commands: extensions/typescript-language-features/src/test/smoke/implementationsCodeLens.test.ts }; });
/*---------------------------------------------------------------------------------------------
