beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/typescript-language-features/src/test/unit/cachedResponse.test.ts, window: extensions/typescript-language-features/src/test/unit/cachedResponse.test.ts, workspace: extensions/typescript-language-features/src/test/unit/cachedResponse.test.ts, ExtensionContext: class extensions/typescript-language-features/src/test/unit/cachedResponse.test.ts, commands: extensions/typescript-language-features/src/test/unit/cachedResponse.test.ts }; });
/*---------------------------------------------------------------------------------------------
