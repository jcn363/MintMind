beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/typescript-language-features/src/test/unit/server.test.ts, window: extensions/typescript-language-features/src/test/unit/server.test.ts, workspace: extensions/typescript-language-features/src/test/unit/server.test.ts, ExtensionContext: class extensions/typescript-language-features/src/test/unit/server.test.ts, commands: extensions/typescript-language-features/src/test/unit/server.test.ts }; });
/*---------------------------------------------------------------------------------------------
