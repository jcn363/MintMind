beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/typescript-language-features/src/test/unit/onEnter.test.ts, window: extensions/typescript-language-features/src/test/unit/onEnter.test.ts, workspace: extensions/typescript-language-features/src/test/unit/onEnter.test.ts, ExtensionContext: class extensions/typescript-language-features/src/test/unit/onEnter.test.ts, commands: extensions/typescript-language-features/src/test/unit/onEnter.test.ts }; });
/*---------------------------------------------------------------------------------------------
