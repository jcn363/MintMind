beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/typescript-language-features/src/test/unit/textRendering.test.ts, window: extensions/typescript-language-features/src/test/unit/textRendering.test.ts, workspace: extensions/typescript-language-features/src/test/unit/textRendering.test.ts, ExtensionContext: class extensions/typescript-language-features/src/test/unit/textRendering.test.ts, commands: extensions/typescript-language-features/src/test/unit/textRendering.test.ts }; });
/*---------------------------------------------------------------------------------------------
