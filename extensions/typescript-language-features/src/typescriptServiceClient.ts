...
import { TelemetryReporter, MintMindTelemetryReporter } from './logging/telemetry';
...
export default class TypeScriptServiceClient extends Disposable implements ITypeScriptServiceClient {
	...
	constructor(
		...
		this.telemetryReporter = new MintMindndTelemetryReporter(services.experimentTelemetryReporter, () => {
			if (this.serverState.type === ServerState.Type.Running) {
