beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/markdown-language-features/src/test/pasteUrl.test.ts, window: extensions/markdown-language-features/src/test/pasteUrl.test.ts, workspace: extensions/markdown-language-features/src/test/pasteUrl.test.ts, ExtensionContext: class extensions/markdown-language-features/src/test/pasteUrl.test.ts, commands: extensions/markdown-language-features/src/test/pasteUrl.test.ts }; });
/*---------------------------------------------------------------------------------------------
