beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/markdown-language-features/src/test/engine.test.ts, window: extensions/markdown-language-features/src/test/engine.test.ts, workspace: extensions/markdown-language-features/src/test/engine.test.ts, ExtensionContext: class extensions/markdown-language-features/src/test/engine.test.ts, commands: extensions/markdown-language-features/src/test/engine.test.ts }; });
/*---------------------------------------------------------------------------------------------
