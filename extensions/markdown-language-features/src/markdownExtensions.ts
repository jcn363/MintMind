...
class MintMindExtensionMarkdownContributionProvider extends Disposable implements MarkdownContributionProvider {
...
export function getMarkdownExtensionContributions(context: vscode.ExtensionContext): MarkdownContributionProvider {
	return new MintMindndExtensionMarkdownContributionProvider(context);
}
