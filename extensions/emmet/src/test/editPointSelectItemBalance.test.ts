beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/emmet/src/test/editPointSelectItemBalance.test.ts, window: extensions/emmet/src/test/editPointSelectItemBalance.test.ts, workspace: extensions/emmet/src/test/editPointSelectItemBalance.test.ts, ExtensionContext: class extensions/emmet/src/test/editPointSelectItemBalance.test.ts, commands: extensions/emmet/src/test/editPointSelectItemBalance.test.ts }; });
/*---------------------------------------------------------------------------------------------
