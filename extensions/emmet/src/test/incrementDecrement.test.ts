beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/emmet/src/test/incrementDecrement.test.ts, window: extensions/emmet/src/test/incrementDecrement.test.ts, workspace: extensions/emmet/src/test/incrementDecrement.test.ts, ExtensionContext: class extensions/emmet/src/test/incrementDecrement.test.ts, commands: extensions/emmet/src/test/incrementDecrement.test.ts }; });
/*---------------------------------------------------------------------------------------------
