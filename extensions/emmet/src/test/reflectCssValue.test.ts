beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/emmet/src/test/reflectCssValue.test.ts, window: extensions/emmet/src/test/reflectCssValue.test.ts, workspace: extensions/emmet/src/test/reflectCssValue.test.ts, ExtensionContext: class extensions/emmet/src/test/reflectCssValue.test.ts, commands: extensions/emmet/src/test/reflectCssValue.test.ts }; });
/*---------------------------------------------------------------------------------------------
