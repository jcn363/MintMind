beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/emmet/src/test/wrapWithAbbreviation.test.ts, window: extensions/emmet/src/test/wrapWithAbbreviation.test.ts, workspace: extensions/emmet/src/test/wrapWithAbbreviation.test.ts, ExtensionContext: class extensions/emmet/src/test/wrapWithAbbreviation.test.ts, commands: extensions/emmet/src/test/wrapWithAbbreviation.test.ts }; });
/*---------------------------------------------------------------------------------------------
