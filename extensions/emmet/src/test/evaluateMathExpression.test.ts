beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/emmet/src/test/evaluateMathExpression.test.ts, window: extensions/emmet/src/test/evaluateMathExpression.test.ts, workspace: extensions/emmet/src/test/evaluateMathExpression.test.ts, ExtensionContext: class extensions/emmet/src/test/evaluateMathExpression.test.ts, commands: extensions/emmet/src/test/evaluateMathExpression.test.ts }; });
/*---------------------------------------------------------------------------------------------
