beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/emmet/src/test/toggleComment.test.ts, window: extensions/emmet/src/test/toggleComment.test.ts, workspace: extensions/emmet/src/test/toggleComment.test.ts, ExtensionContext: class extensions/emmet/src/test/toggleComment.test.ts, commands: extensions/emmet/src/test/toggleComment.test.ts }; });
/*---------------------------------------------------------------------------------------------
