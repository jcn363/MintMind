beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/emmet/src/test/abbreviationAction.test.ts, window: extensions/emmet/src/test/abbreviationAction.test.ts, workspace: extensions/emmet/src/test/abbreviationAction.test.ts, ExtensionContext: class extensions/emmet/src/test/abbreviationAction.test.ts, commands: extensions/emmet/src/test/abbreviationAction.test.ts }; });
/*---------------------------------------------------------------------------------------------
