beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/emmet/src/test/partialParsingStylesheet.test.ts, window: extensions/emmet/src/test/partialParsingStylesheet.test.ts, workspace: extensions/emmet/src/test/partialParsingStylesheet.test.ts, ExtensionContext: class extensions/emmet/src/test/partialParsingStylesheet.test.ts, commands: extensions/emmet/src/test/partialParsingStylesheet.test.ts }; });
/*---------------------------------------------------------------------------------------------
