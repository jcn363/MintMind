beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/emmet/src/test/cssAbbreviationAction.test.ts, window: extensions/emmet/src/test/cssAbbreviationAction.test.ts, workspace: extensions/emmet/src/test/cssAbbreviationAction.test.ts, ExtensionContext: class extensions/emmet/src/test/cssAbbreviationAction.test.ts, commands: extensions/emmet/src/test/cssAbbreviationAction.test.ts }; });
/*---------------------------------------------------------------------------------------------
