beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/emmet/src/test/updateImageSize.test.ts, window: extensions/emmet/src/test/updateImageSize.test.ts, workspace: extensions/emmet/src/test/updateImageSize.test.ts, ExtensionContext: class extensions/emmet/src/test/updateImageSize.test.ts, commands: extensions/emmet/src/test/updateImageSize.test.ts }; });
/*---------------------------------------------------------------------------------------------
