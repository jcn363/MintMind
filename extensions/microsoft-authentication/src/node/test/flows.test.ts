beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/microsoft-authentication/src/node/test/flows.test.ts, window: extensions/microsoft-authentication/src/node/test/flows.test.ts, workspace: extensions/microsoft-authentication/src/node/test/flows.test.ts, ExtensionContext: class extensions/microsoft-authentication/src/node/test/flows.test.ts, commands: extensions/microsoft-authentication/src/node/test/flows.test.ts }; });
/*---------------------------------------------------------------------------------------------
