beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/microsoft-authentication/src/common/test/loopbackClientAndOpener.test.ts, window: extensions/microsoft-authentication/src/common/test/loopbackClientAndOpener.test.ts, workspace: extensions/microsoft-authentication/src/common/test/loopbackClientAndOpener.test.ts, ExtensionContext: class extensions/microsoft-authentication/src/common/test/loopbackClientAndOpener.test.ts, commands: extensions/microsoft-authentication/src/common/test/loopbackClientAndOpener.test.ts }; });
/*---------------------------------------------------------------------------------------------
