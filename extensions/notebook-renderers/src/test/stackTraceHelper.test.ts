beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/notebook-renderers/src/test/stackTraceHelper.test.ts, window: extensions/notebook-renderers/src/test/stackTraceHelper.test.ts, workspace: extensions/notebook-renderers/src/test/stackTraceHelper.test.ts, ExtensionContext: class extensions/notebook-renderers/src/test/stackTraceHelper.test.ts, commands: extensions/notebook-renderers/src/test/stackTraceHelper.test.ts }; });
/*---------------------------------------------------------------------------------------------
