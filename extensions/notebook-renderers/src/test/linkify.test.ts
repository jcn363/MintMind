beforeAll(() => { (globalThis as any).vscode = { Uri: class extensions/notebook-renderers/src/test/linkify.test.ts, window: extensions/notebook-renderers/src/test/linkify.test.ts, workspace: extensions/notebook-renderers/src/test/linkify.test.ts, ExtensionContext: class extensions/notebook-renderers/src/test/linkify.test.ts, commands: extensions/notebook-renderers/src/test/linkify.test.ts }; });
/*---------------------------------------------------------------------------------------------
