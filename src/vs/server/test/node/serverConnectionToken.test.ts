...
describe('parseServerConnectionToken', () => {
	...
	it('no arguments generates a token that is mandatory', async () => {
	...
	it('--without-connection-token', async () => {
	...
	it('--without-connection-token --connection-token results in error', async () => {
	...
	it('--without-connection-token --connection-token-file results in error', async () => {
	...
	it('--connection-token-file --connection-token results in error', async () => {
	...
	it('--connection-token-file', async function () {
		this.timeout(10000);
