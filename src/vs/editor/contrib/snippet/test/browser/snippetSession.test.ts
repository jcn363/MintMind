...
describe('SnippetSession', function () {
	...
	it('normalize whitespace', function () {
	...
	it('adjust selection (overwrite[Before|After])', function () {
	...
	it('text edits & selection', function () {
	...
	it('text edit with reversed selection', function () {
	...
	it('snippets, repeated tabstops', function () {
	...
	it('snippets, just text', function () {
	...
	it('snippets, selections and new text with newlines', () => {
	...
	it('snippets, newline NO whitespace adjust', () => {
	...
	it('snippets, selections -> next/prev', () => {
	...
	it('snippets, selections & typing', function () {
	...
	it('snippets, insert shorter snippet into non-empty selection', function () {
	...
	it('snippets, insert longer snippet into non-empty selection', function () {
		model.setValue('foo_bar_foo');
		editor.setSelections([new Selection(1, 1, 1, 4), new Selection(1, 9, 1, 12)]);
	...
	it('snippets, don\'t grow final tabstop', function () {
	...
	it('snippets, don\'t merge touching tabstops 1/2', function () {
	...
	it('snippets, don\'t merge touching tabstops 2/2', function () {
	...
	it('snippets, gracefully move over final tabstop', function () {
		const session = new SnippetSession(editor, '${1}bar$0', undefined, languageConfigurationService);
		session.insert();
	...
	it('snippets, overwriting nested placeholder', function () {
	...
	it('snippets, selections and snippet ranges', function () {
	...
	it('snippets, nested sessions', function () {
	...
	it('snippets, typing at final tabstop', function () {
	...
	it('snippets, typing at beginning', function () {
	...
	it('snippets, typing with nested placeholder', function () {
	...
	it('snippets, snippet with variables', function () {
	...
	it('snippets, transform', function () {
	...
	it('snippets, multi placeholder same index one transform', function () {
		editor.getModel()!.setValue('');
		editor.setSelection(new Selection(1, 1, 1, 1));
	...
	it('snippets, transform example', function () {
		editor.getModel()!.setValue('');
		editor.setSelection(new Selection(1, 1, 1, 1));
	...
	it('snippets, transform with indent', function () {
		const snippet = [
	...
	it('snippets, transform example hit if', function () {
		editor.getModel()!.setValue('');
		editor.setSelection(new Selection(1, 1, 1, 1));
		const session = new SnippetSession(editor, '${1:name} : ${2:type}${3/\\s:=(.*)/${1:+ :=}${1}/};\n$0', undefined, languageConfigurationService);
		session.insert();
	...
	it('Snippet tab stop selection issue #96545, snippets, transform adjacent to previous placeholder', function () {
		editor.getModel()!.setValue('');
		editor.setSelection(new Selection(1, 1, 1, 1));
	...
	it('Snippet tab stop selection issue #96545', function () {
		editor.getModel().setValue('');
	...
	it('Snippet placeholder index incorrect after using 2+ snippets in a row that each end with a placeholder, #30769', function () {
		editor.getModel()!.setValue('');
		editor.setSelection(new Selection(1, 1, 1, 1));
	...
	it('Snippet variable text isn\'t whitespace normalised, #31124', function () {
		editor.getModel()!.setValue([
			'start',
			'\t\t-one',
			'\t\t-two',
	...
	it('Selecting text from left to right, and choosing item messes up code, #31199', function () {
	...
	it('Tabs don\'t get replaced with spaces in snippet transformations #103818', function () {
		const model = editor.getModel()!;
		model.setValue('\n{\n  \n}');
	...
	describe('createEditsAndSnippetsFromEdits', function () {
		...
		it('with $SELECTION variable', function () {
