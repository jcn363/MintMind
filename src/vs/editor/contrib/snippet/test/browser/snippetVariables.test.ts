...
describe('Snippet Variables Resolver', function () {
	...
	it('Path delimiters in code snippet variables aren\'t specific to remote OS #76840', function () {
	...
	it('editor variables, selection', function () {
	...
	it('TextmateSnippet, resolve variable', function () {
	...
	it('TextmateSnippet, resolve variable with default', function () {
	...
	it('More useful environment variables for snippets, #32737', function () {
	...
	it('Variable Snippet Transform', function () {
	...
	it('Snippet transforms do not handle regex with alternatives or optional matches, #36089', function () {
	...
	it('Add variable to insert value from clipboard to a snippet #40153', function () {
	...
	it('Add variable to insert value from clipboard to a snippet #40153, 2', function () {
	...
	it('Add time variables for snippets #41631, #43140', function () {
	...
	it('Time-based snippet variables resolve to the same values even as time progresses', async function () {
		const snippetText = `
			$CURRENT_YEAR
			$CURRENT_YEAR_SHORT
			$CURRENT_MONTH
	...
	it('creating snippet - format-condition doesn\'t work #53617', function () {
	...
	it('Add workspace name and folder variables for snippets #68261', function () {
	...
	it('Add RELATIVE_FILEPATH snippet variable #114208', function () {
