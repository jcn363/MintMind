...
describe('SmartSelect', () => {
	...
	it('config: selectLeadingAndTrailingWhitespace', async () => {
	...
	it('getRangesToPosition #56886. Skip empty lines correctly.', () => {
	...
	it('getRangesToPosition #56886. Do not skip lines with only whitespaces.', () => {
	...
	it('getRangesToPosition #40658. Cursor at first position inside brackets should select line inside.', () => {
	...
	it('getRangesToPosition #40658. Cursor in empty brackets should reveal brackets first.', () => {
	...
	it('getRangesToPosition #40658. Tokens before bracket will be revealed first.', () => {
	...
	it('bracket with leading/trailing', async () => {
	...
	it('in-word ranges with selectSubwords=false', async () => {
	...
	it('Default selection should select current word/hump first in camelCase #67493', async function () {
	...
	it('Smart select: only add line ranges if they\'re contained by the next range #73850', async function () {
	...
	it('Expand selection in words with underscores is inconsistent #90589', async function () {
