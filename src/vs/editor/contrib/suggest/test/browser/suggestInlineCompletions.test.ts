...
describe('Suggest Inline Completions', function () {
	...
	it('Aggressive inline completions when typing within line #146948', async function () {
	...
	it('Snippets show in inline suggestions even though they are turned off #175190', async function () {
		const completions: SuggestInlineCompletions = disposables.add(insta.createInstance(SuggestInlineCompletions));
