...
describe('SuggestModel - Context', function () {
	...
	it('Context - shouldAutoTrigger', function () {
	...
	it('shouldAutoTrigger at embedded language boundaries', () => {
...
describe('SuggestModel - TriggerAndCancelOracle', function () {
	...
	it('events - cancel/trigger', function () {
	...
	it('events - suggest/empty', function () {
	...
	it('#17400: Keep filtering suggestModel.ts after space', function () {
	...
	it('#21484: Trigger character always force a new completion session', function () {
	...
	it('Intellisense Completion doesn\'t respect space after equal sign (.html file), #29353 [1/2]', function () {
	...
	it('Intellisense Completion doesn\'t respect space after equal sign (.html file), #29353 [2/2]', function () {
	...
	it('Incomplete suggestion results cause re-triggering when typing w/o further context, #28400 (1/2)', function () {
	...
	it('Incomplete suggestion results cause re-triggering when typing w/o further context, #28400 (2/2)', function () {
	...
	it('Trigger character is provided in suggest context', function () {
	...
	it('Mac press and hold accent character insertion does not update suggestions, #35269', function () {
		disposables.add(registry.register({ scheme: 'test' }, {
			_debugDisplayName: 'test',
			provideCompletionItems(doc, pos): CompletionList {
				return {
	...
	it('Backspace should not always cancel code completion, #36491', function () {
		disposables.add(registry.register({ scheme: 'test' }, alwaysSomethingSupport));
	...
	it('Text changes for completion CodeAction are affected by the completion #39893', function () {
		disposables.add(registry.register({ scheme: 'test' }, {
			_debugDisplayName: 'test',
			provideCompletionItems(doc, pos): CompletionList {
				return {
	...
	it('Completion unexpectedly triggers on second keypress of an edit group in a snippet #43523', function () {
	...
	it('Fails to render completion details #47988', function () {
	...
	it('Trigger (full) completions when (incomplete) completions are already active #99504', function () {
	...
	it('registerCompletionItemProvider with letters as trigger characters block other completion items to show up #127815', async function () {
	...
	it('Unexpected suggest scoring #167242', async function () {
	...
	it('Completion list closes unexpectedly when typing a digit after a word separator #169390', function () {
	...
	it('Set refilter-flag, keep triggerKind', function () {
	...
	it('Snippets gone from IntelliSense #173244', function () {
