...
describe('CompletionModel', function () {
	...
	it('Fuzzy matching of snippets stopped working with inline snippet suggestions #49895', function () {
	...
	it('proper current word when length=0, #16380', function () {
	...
	it('keep snippet sorting with prefix: top, #25495', function () {
	...
	it('keep snippet sorting with prefix: bottom, #25495', function () {
	...
	it('keep snippet sorting with prefix: inline, #25495', function () {
	...
	it('filterText seems ignored in autocompletion, #26874', function () {
	...
	it('Completion item sorting broken when using label details #153026', function () {
	...
	it('Score only filtered items when typing more, score all when typing less', function () {
		model = new CompletionModel([
	...
	it('Have more relaxed suggest matching algorithm #15419', function () {
		model = new CompletionModel([
	...
	it('Emmet suggestion not appearing at the top of the list in jsx files, #39518', function () {
		model = new CompletionModel([
