...
describe('Suggest', function () {
	...
	it('sort - snippet inline', async function () {
	...
	it('sort - snippet top', async function () {
	...
	it('sort - snippet bottom', async function () {
	...
	it('sort - snippet none', async function () {
	...
	it('only from', function (callback) {
	...
	it('Ctrl+space completions stopped working with the latest Insiders, #97650', async function () {
