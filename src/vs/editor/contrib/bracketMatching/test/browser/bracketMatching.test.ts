...
describe('bracket matching', () => {
	...
	it('issue #183: jump to matching bracket position', () => {
	...
	it('issue #1772: jump to enclosing brackets', () => {
		const text = [
			'const x = {',
			'    something: [0, 1, 2],',
			'    another: true,',
	...
	it('issue #43371: argument to not select brackets', () => {
		const text = [
			'const x = {',
			'    something: [0, 1, 2],',
			'    another: true,',
	...
	it('issue #45369: Select to Bracket with multicursor', () => {
