...
describe('Editor Contrib - Sort Lines Command', () => {
	...
	it('no op unless at least two lines selected 1', function () {
	...
	it('no op unless at least two lines selected 2', function () {
		testSortLinesAscendingCommand(
			[
				'first',
				'second line',
	...
	it('sorting two lines ascending', function () {
		testSortLinesAscendingCommand(
			[
				'first',
				'second line',
	...
	it('sorting first 4 lines ascending', function () {
		testSortLinesAscendingCommand(
			[
				'first',
				'second line',
	...
	it('sorting all lines ascending', function () {
		testSortLinesAscendingCommand(
			[
				'first',
				'second line',
	...
	it('sorting first 4 lines descending', function () {
	...
	it('sorting all lines descending', function () {
		testSortLinesDescendingCommand(
			[
				'first',
				'second line',
