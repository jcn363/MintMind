...
describe('Editor Contrib - Copy Lines Command', () => {
	...
	it('copy first line down', function () {
	...
	it('copy first line up', function () {
	...
	it('copy last line down', function () {
		testCopyLinesDownCommand(
			[
				'first',
				'second line',
	...
	it('issue #1322: copy line up', function () {
		testCopyLinesUpCommand(
			[
				'first',
				'second line',
	...
	it('issue #1322: copy last line up', function () {
		testCopyLinesUpCommand(
			[
				'first',
				'second line',
	...
	it('copy many lines up', function () {
		testCopyLinesUpCommand(
			[
				'first',
				'second line',
	...
	it('ignore empty selection', function () {
		testCopyLinesUpCommand(
			[
				'first',
				'second line',
