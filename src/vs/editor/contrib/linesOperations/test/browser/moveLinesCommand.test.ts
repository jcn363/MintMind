...
describe('Editor Contrib - Move Lines Command', () => {
	...
	it('move first up / last down disabled', function () {
	...
	it('move first line down', function () {
		testMoveLinesDownCommand(
			[
				'first',
				'second line',
	...
	it('issue #1322a: move 2nd line up', function () {
		testMoveLinesUpCommand(
			[
				'first',
				'second line',
	...
	it('issue #1322b: move last line up', function () {
		testMoveLinesUpCommand(
			[
				'first',
				'second line',
	...
	it('issue #1322c: move last line selected up', function () {
		testMoveLinesUpCommand(
			[
				'first',
				'second line',
	...
	it('move 4th line down', function () {
		testMoveLinesDownCommand(
			[
				'first',
				'second line',
	...
	it('move multiple lines down', function () {
		testMoveLinesDownCommand(
			[
				'first',
				'second line',
	...
	it('invisible selection is ignored', function () {
		testMoveLinesDownCommand(
			[
				'first',
				'second line',
...
describe('Editor contrib - Move Lines Command honors Indentation Rules', () => {
	...
	it('first line indentation adjust to 0', () => {
	...
	it('move line should still work as before if there is no indentation rules', () => {
		testMoveLinesUpWithIndentCommand(
			null!,
			[
				'if (true) {',
...
describe('Editor - contrib - Move Lines Command honors onEnter Rules', () => {
	...
	it('issue #54829. move block across block', () => {
		const languageService = new LanguageService();
		const languageConfigurationService = new TestLanguageConfigurationService();
