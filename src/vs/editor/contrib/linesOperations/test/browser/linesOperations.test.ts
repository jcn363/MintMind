...
describe('Editor Contrib - Line Operations', () => {
	...
	describe('SortLinesAscendingAction', () => {
		it('should sort selected lines in ascending order', function () {
			withTestCodeEditor(
				[
					'omicron',
					'beta',
		...
		it('should sort lines in ascending order', function () {
			withTestCodeEditor(
				[
					'omicron',
					'beta',
		...
		it('should sort multiple selections in ascending order', function () {
			withTestCodeEditor(
				[
					'omicron',
					'beta',
	...
	describe('SortLinesDescendingAction', () => {
		it('should sort selected lines in descending order', function () {
			withTestCodeEditor(
				[
					'alpha',
					'beta',
		...
		it('should sort multiple selections in descending order', function () {
			withTestCodeEditor(
				[
					'alpha',
					'beta',
	...
	describe('DeleteDuplicateLinesAction', () => {
		it('should remove duplicate lines within selection', function () {
			withTestCodeEditor(
				[
					'alpha',
					'beta',
		...
		it('should remove duplicate lines', function () {
			withTestCodeEditor(
				[
					'alpha',
					'beta',
		...
		it('should remove duplicate lines in multiple selections', function () {
			withTestCodeEditor(
				[
					'alpha',
					'beta',
	...
	describe('DeleteAllLeftAction', () => {
		it('should delete to the left of the cursor', function () {
			withTestCodeEditor(
				[
					'one',
					'two',
		...
		it('should jump to the previous line when on first column', function () {
			withTestCodeEditor(
				[
					'one',
					'two',
		...
		it('should keep deleting lines in multi cursor mode', function () {
			withTestCodeEditor(
				[
		...
		it('should work in multi cursor mode', function () {
			withTestCodeEditor(
				[
					'hello',
					'world',
		...
		it('issue #36234: should push undo stop', () => {
			withTestCodeEditor(
				[
					'one',
					'two',
	...
	describe('JoinLinesAction', () => {
		it('should join lines and insert space if necessary', function () {
			withTestCodeEditor(
				[
					'hello',
					'world',
		...
		it('#50471 Join lines at the end of document', function () {
			withTestCodeEditor(
				[
					'hello',
					'world'
		...
		it('should push undo stop', function () {
			withTestCodeEditor(
				[
					'hello',
					'world'
	...
	describe('ReverseLinesAction', () => {
		it('reverses lines', function () {
			withTestCodeEditor(
				[
					'alice',
					'bob',
		...
		it('excludes empty last line', function () {
			withTestCodeEditor(
				[
					'alice',
					'bob',
		...
		it('preserves cursor on empty last line', function () {
			withTestCodeEditor(
				[
					'alice',
					'bob',
		...
		it('preserves selected text when selections do not span lines', function () {
			withTestCodeEditor(
				[
					'alice',
					'bob',
		...
		it('reverses lines within selection', function () {
			withTestCodeEditor(
				[
					'line1',
					'line2',
		...
		it('reverses lines within partial selection', function () {
			withTestCodeEditor(
				[
					'line1',
					'line2',
		...
		it('reverses lines with multiple selections', function () {
			withTestCodeEditor(
				[
					'line1',
					'line2',
		...
		it('updates selection positions after reversal', function () {
			withTestCodeEditor(
				[
					'line1',
					'line2',
		...
		it('excludes end line when selection ends at column 1', function () {
			withTestCodeEditor(
				[
					'line1',
					'line2',
	...
	describe('DeleteAllRightAction', () => {
		...
		it('should delete selected range', () => {
			withTestCodeEditor([
				'hello',
				'world'
			], {}, (editor) => {
		...
		it('should delete to the right of the cursor', () => {
			withTestCodeEditor([
				'hello',
				'world'
			], {}, (editor) => {
		...
		it('should join two lines, if at the end of the line', () => {
			withTestCodeEditor([
				'hello',
				'world'
			], {}, (editor) => {
		...
		it('should work with multiple cursors', () => {
			withTestCodeEditor([
				'hello',
				'there',
				'world'
	...
	it('Bug 18276:[editor] Indentation broken when selection is empty', () => {
	...
	it('issue #80736: Indenting while the cursor is at the start of a line of text causes the added spaces or tab to be selected', () => {
		const model = createTextModel(
			[
				'Some text'
			].join('\n'),
	...
	it('Indenting on empty line should move cursor', () => {
		const model = createTextModel(
			[
				''
			].join('\n')
	...
	it('issue #62112: Delete line does not work properly when multiple cursors are on line', () => {
		const TEXT = [
			'a',
			'foo boo',
			'too',
	...
	it('empty selection in middle of lines', function () {
	...
	it('empty selection at top of lines', function () {
		testDeleteLinesCommand(
			[
				'first',
				'second line',
	...
	it('empty selection at end of lines', function () {
		testDeleteLinesCommand(
			[
				'first',
				'second line',
	...
	it('with selection in middle of lines', function () {
		testDeleteLinesCommand(
			[
				'first',
				'second line',
	...
	it('with selection at top of lines', function () {
		testDeleteLinesCommand(
			[
				'first',
				'second line',
	...
	it('with selection at end of lines', function () {
		testDeleteLinesCommand(
			[
				'first',
				'second line',
	...
	it('with full line selection in middle of lines', function () {
		testDeleteLinesCommand(
			[
				'first',
				'second line',
	...
	it('with full line selection at top of lines', function () {
		testDeleteLinesCommand(
			[
				'first',
				'second line',
	...
	it('with full line selection at end of lines', function () {
		testDeleteLinesCommand(
			[
				'first',
				'second line',
