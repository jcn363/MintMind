...
describe('Hover Copy Button', () => {
	...
	it('should create button element in container', () => {
	...
	it('should add hover-row-with-copy class to container', () => {
	...
	it('should copy content on click', async () => {
	...
	it('should copy content on Enter key', async () => {
	...
	it('should copy content on Space key', async () => {
