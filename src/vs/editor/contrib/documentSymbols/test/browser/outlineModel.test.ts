...
describe('OutlineModel', function () {
	...
	it('OutlineModel#create, cached', async function () {
	...
	it('OutlineModel#create, cached/cancel', async function () {
	...
	it('OutlineElement - updateMarker', function () {
	...
	it('OutlineElement - updateMarker, 2', function () {
	...
	it('OutlineElement - updateMarker/multiple groups', function () {
