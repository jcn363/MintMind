...
describe('Editor Contrib - Move Caret Command', () => {
	...
	it('move selection to left', function () {
	...
	it('move selection to right', function () {
	...
	it('move selection to left - from first column - no change', function () {
		testMoveCaretLeftCommand(
			[
				'012345'
			],
	...
	it('move selection to right - from last column - no change', function () {
		testMoveCaretRightCommand(
			[
				'012345'
			],
