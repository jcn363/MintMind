...
describe('Editor Contrib - Line Comment Command', () => {
	...
	it('comment with token column fixed', function () {
	...
	it('detects mixed indentation', function () {
		testLineCommentCommand(
			[
				'\tsome text',
				'    some more text'
	...
	it('ignores whitespace lines', function () {
		testLineCommentCommand(
			[
				'\tsome text',
				'\t   ',
	...
	it('works in only whitespace', function () {
		testLineCommentCommand(
			[
				'\t    ',
				'\t',
	...
	it('bug 9697 - whitespace before comment token', function () {
		testLineCommentCommand(
			[
				'\t !@#first',
				'\tsecond line'
	...
	it('bug 10162 - line comment before caret', function () {
		testLineCommentCommand(
			[
				'first!@#',
				'\tsecond line'
	...
	it('comment single line - leading whitespace', function () {
		testLineCommentCommand(
			[
				'first!@#',
				'\tsecond line'
	...
	it('ignores invisible selection', function () {
		testLineCommentCommand(
			[
				'first',
				'\tsecond line',
	...
	it('multiple modes on multiple lines', function () {
		testLineCommentCommand(
			[
				'first',
				'\tsecond line',
	...
	it('toggle single line', function () {
		testLineCommentCommand(
			[
				'first',
				'\tsecond line',
	...
	it('toggle multiple lines', function () {
		testLineCommentCommand(
			[
				'first',
				'\tsecond line',
	...
	it('issue #5964: Ctrl+/ to create comment when cursor is at the beginning of the line puts the cursor in a strange position', () => {
		testLineCommentCommand(
			[
				'first',
				'\tsecond line',
	...
	it('issue #35673: Comment hotkeys throws the cursor before the comment', () => {
		testLineCommentCommand(
			[
				'first',
				'',
	...
	it('issue #2837 "Add Line Comment" fault when blank lines involved', function () {
	...
	it('issue #47004: Toggle comments shouldn\'t move cursor', () => {
		testAddLineCommentCommand(
			[
				'    A line',
				'    Another line'
	...
	it('insertSpace false does not remove space', () => {
		const testLineCommentCommand = createTestCommandHelper(
			{ lineComment: '!@#' },
			(accessor, sel) => new LineCommentCommand(accessor.get(ILanguageConfigurationService), sel, 4, Type.Toggle, false, true)
		);
...
describe('ignoreEmptyLines false', () => {
	...
	it('does not ignore whitespace lines', () => {
		testLineCommentCommand(
			[
				'\tsome text',
				'\t   ',
...
describe('Editor Contrib - Line Comment As Block Comment', () => {
	...
	it('fall back to block comment command', function () {
		testLineCommentCommand(
			[
				'first',
				'\tsecond line',
	...
	it('fall back to block comment command - toggle', function () {
		testLineCommentCommand(
			[
				'(first)',
				'\tsecond line',
	...
	it('bug 9513 - expand single line to uncomment auto block', function () {
		testLineCommentCommand(
			[
				'first',
				'\tsecond line',
	...
	it('bug 9691 - always expand selection to line boundaries', function () {
		testLineCommentCommand(
			[
				'first',
				'\tsecond line',
...
describe('Editor Contrib - Line Comment As Block Comment 2', () => {
	...
	it('no selection => uses indentation', function () {
		testLineCommentCommand(
			[
				'\t\tfirst\t    ',
				'\t\tsecond line',
	...
	it('issue #993: Remove comment does not work consistently in HTML', () => {
		testLineCommentCommand(
			[
				'     asd qwe',
				'     asd qwe',
...
describe('Editor Contrib - Line Comment in mixed modes', () => {
		...
		constructor(
			...
			this._register(TokenizationRegistry.register(this.languageId, {
				...
				tokenizeEncoded: (line: string, hasEOL: boolean, state: IState): EncodedTokenizationResult => {
					const languageId = (/^  /.it(line) ? INNER_LANGUAGE_ID : OUTER_LANGUAGE_ID);
	...
	it('issue #24047 (part 1): Commenting code in JSX files', () => {
		testLineCommentCommand(
			[
	...
	it('issue #24047 (part 2): Commenting code in JSX files', () => {
		testLineCommentCommand(
			[
				'import React from \'react\';',
				'const Loader = () => (',
	...
	it('issue #36173: Commenting code in JSX tag body', () => {
		testLineCommentCommand(
			[
				'<div>',
				'  {123}',
