...
describe('Editor Contrib - Block Comment Command', () => {
	...
	it('empty selection wraps itself', function () {
	...
	it('invisible selection ignored', function () {
		testBlockCommentCommand(
			[
				'first',
				'\tsecond line',
	...
	it('one line selection', function () {
		testBlockCommentCommand(
			[
				'first',
				'\tsecond line',
	...
	it('one line selection toggle', function () {
		testBlockCommentCommand(
			[
				'first',
				'\tsecond line',
	...
	it('multi line selection', function () {
		testBlockCommentCommand(
			[
				'first',
				'\tsecond line',
	...
	it('multi line selection toggle', function () {
		testBlockCommentCommand(
			[
				'first',
				'\tsecond line',
