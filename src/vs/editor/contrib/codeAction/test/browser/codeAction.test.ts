...
describe('CodeAction', () => {
	...
	it('CodeActions are sorted by type, #38623', async () => {
	...
	it('getCodeActions should filter by scope', async () => {
		const provider = staticCodeActionProvider(
			{ title: 'a', kind: 'a' },
			{ title: 'b', kind: 'b' },
			{ title: 'a.b', kind: 'a.b' }
	...
	it('getCodeActions should forward requested scope to providers', async () => {
	...
	it('getCodeActions should not return source code action by default', async () => {
		const provider = staticCodeActionProvider(
	...
	it('getCodeActions should support filtering out some requested source code actions #84602', async () => {
		const provider = staticCodeActionProvider(
			{ title: 'a', kind: CodeActionKind.Source.value },
	...
	it('getCodeActions no invoke a provider that has been excluded #84602', async () => {
	...
	it('getCodeActions should not invoke code action providers filtered out by providedCodeActionKinds', async () => {
