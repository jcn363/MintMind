...
export async function loadEditorContributions(): Promise<void> {
	await Promise.all([
	...
	await import('../base/browser/ui/codicons/codiconStyles.js'); // The codicons are defined here and must be loaded
}
