...
describe('Editor Side Editing - collapsed selection', () => {
	...
	it('insert at selection sitting on max column', () => {
		testCommand(
			[
				'first',
				'second line',
	...
	it('issue #3994: replace on top of selection', () => {
		testCommand(
			[
	...
	it('issue #15267: Suggestion that adds a line - cursor goes to the wrong line ', () => {
		testCommand(
			[
				'package main',
				'',
	...
	it('issue #15236: Selections broke after deleting text using vscode.TextEditor.edit ', () => {
		testCommand(
			[
