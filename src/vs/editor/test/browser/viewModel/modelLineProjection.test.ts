...
describe('Editor ViewModel - SplitLinesCollection', () => {
...
describe('SplitLinesCollection', () => {
	...
	it('getViewLinesData - no wrapping', () => {
	...
	it('getViewLinesData - with wrapping', () => {
	...
	it('getViewLinesData - with wrapping and injected text', () => {
