...
describe('TextAreaState', () => {
	...
	it('extractNewText - no previous state with selection', () => {
		testDeduceInput(
			null,
			'a',
			0, 1, true,
	...
	it('extractNewText - no previous state without selection', () => {
		testDeduceInput(
			null,
			'a',
			1, 1, true,
	...
	it('extractNewText - typing does not cause a selection', () => {
		testDeduceInput(
			TextAreaState.EMPTY,
			'a',
			0, 1, true,
	...
	it('extractNewText - had the textarea empty', () => {
		testDeduceInput(
			TextAreaState.EMPTY,
			'a',
			1, 1, true,
	...
	it('extractNewText - had the entire line selected', () => {
		testDeduceInput(
	...
	it('extractNewText - had previous text 1', () => {
		testDeduceInput(
	...
	it('extractNewText - had previous text 2', () => {
		testDeduceInput(
	...
	it('extractNewText - had previous text 3', () => {
		testDeduceInput(
	...
	it('extractNewText - isInOverwriteMode', () => {
		testDeduceInput(
			new TextAreaState('Hello world!', 0, 0, null, undefined),
			'Aello world!',
			1, 1, true,
	...
	it('extractMacReplacedText - does nothing if there is selection', () => {
		testDeduceInput(
	...
	it('extractMacReplacedText - does nothing if there is more than one extra char', () => {
		testDeduceInput(
			new TextAreaState('Hello world!', 5, 5, null, undefined),
			'Hellöö world!',
			5, 5, true,
	...
	it('extractMacReplacedText - does nothing if there is more than one changed char', () => {
		testDeduceInput(
			new TextAreaState('Hello world!', 5, 5, null, undefined),
			'Helöö world!',
			5, 5, true,
	...
	it('issue #25101 - First key press ignored', () => {
		testDeduceInput(
	...
	it('issue #16520 - Cmd-d of single character followed by typing same character as has no effect', () => {
		testDeduceInput(
	...
	it('Android composition input 1', () => {
	...
	it('Android composition input 2', () => {
		testDeduceAndroidCompositionInput(
			new TextAreaState('Microsoft', 4, 4, null, undefined),
			'Microsoft',
			0, 9,
	...
	it('Android composition input 3', () => {
		testDeduceAndroidCompositionInput(
	...
	describe('SimplePagedScreenReaderStrategy', () => {
