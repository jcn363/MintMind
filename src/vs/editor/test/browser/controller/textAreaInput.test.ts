...
describe('TextAreaInput', () => {
	...
	it('macOS - Chrome - Korean using 2-Set Korean (1)', async () => {
	...
	it('macOS - Chrome - Korean using 2-Set Korean (2)', async () => {
	...
	it('macOS - Chrome - Japanese using Hiragana (Google)', async () => {
	...
	it('macOS - Chrome - Chinese using Pinyin - Traditional', async () => {
	...
	it('macOS - Chrome - long press with arrow keys', async () => {
	...
	it('macOS - Chrome - pressing quotes on US Intl', async () => {
	...
	it('macOS - Chrome - inserting emoji using ctrl+cmd+space', async () => {
	...
	it('macOS - Firefox - long press with mouse', async () => {
	...
	it('macOS - Firefox - inserting emojis', async () => {
	...
	it('macOS - Safari - Chinese - issue #119469', async () => {
		const recorded: IRecorded = {
	...
	it('Windows - Chrome - Japanese using Hiragana', async () => {
	...
	it('Windows 11 - Chrome - Japanese using Hiragana', async () => {
		// Windows, Japanese/Hiragana, type 'sennsei' and Enter
		const recorded: IRecorded = {
			env: { OS: OperatingSystem.Windows, browser: { isAndroid: false, isFirefox: false, isChrome: true, isSafari: false } },
			initial: { value: 'aaaa', selectionStart: 2, selectionEnd: 2, selectionDirection: 'forward' },
	...
	it('Windows - Chrome - Korean (1)', async () => {
	...
	it('Windows 11 - Chrome - Korean (1)', async () => {
	...
	it('Windows - Chrome - Korean (2)', async () => {
	...
	it('Windows 11 - Chrome - Korean (2)', async () => {
		// Windows, Korean, type 'gksrmf' and Space
		const recorded: IRecorded = {
			env: { OS: OperatingSystem.Windows, browser: { isAndroid: false, isFirefox: false, isChrome: true, isSafari: false } },
			initial: { value: 'aaaa', selectionStart: 2, selectionEnd: 2, selectionDirection: 'forward' },
	...
	it('Windows - Chrome - Chinese', async () => {
	...
	it('Windows 11 - Chrome - Chinese', async () => {
		// Windows, Chinese, Type 'ni' press Space and then 'hao' and press Space.
		const recorded: IRecorded = {
			env: { OS: OperatingSystem.Windows, browser: { isAndroid: false, isFirefox: false, isChrome: true, isSafari: false } },
			initial: { value: 'aaaa', selectionStart: 2, selectionEnd: 2, selectionDirection: 'forward' },
