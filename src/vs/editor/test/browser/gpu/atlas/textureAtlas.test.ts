...
describe('TextureAtlas', () => {
	...
	it('adding glyph to full page creates new page', () => {
	...
	it('adding a glyph larger than the atlas', () => {
	...
	it('adding a glyph larger than the standard slab size', () => {
	...
	it('adding a non-first glyph larger than the standard slab size, causing an overflow to a new page', () => {
