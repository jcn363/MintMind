...
describe('Editor Model - Model', () => {
	...
	it('model insert text without newline 2', () => {
	...
	it('model insert text with one newline', () => {
	...
	it('model insert text with two newlines', () => {
	...
	it('model insert text with many newlines', () => {
	...
	it('model insert empty text does not trigger eventing', () => {
	...
	it('model insert text without newline eventing', () => {
	...
	it('model insert text with one newline eventing', () => {
		let e: ModelRawContentChangedEvent | null = null;
		const disposable = thisModel.onDidChangeContentOrInjectedText((_e) => {
			if (e !== null || !(_e instanceof InternalModelContentChangeEvent)) {
				assert.fail('Unexpected assertion error');
	...
	it('model delete text from many lines', () => {
	...
	it('model delete empty text does not trigger eventing', () => {
		const disposable = thisModel.onDidChangeContentOrInjectedText((e) => {
			assert.ok(false, 'was not expecting event');
		});
		thisModel.applyEdits([EditOperation.delete(new Range(1, 1, 1, 1))]);
	...
	it('model delete text from one line eventing', () => {
		let e: ModelRawContentChangedEvent | null = null;
		const disposable = thisModel.onDidChangeContentOrInjectedText((_e) => {
			if (e !== null || !(_e instanceof InternalModelContentChangeEvent)) {
				assert.fail('Unexpected assertion error');
	...
	it('model delete all text from a line eventing', () => {
		let e: ModelRawContentChangedEvent | null = null;
		const disposable = thisModel.onDidChangeContentOrInjectedText((_e) => {
			if (e !== null || !(_e instanceof InternalModelContentChangeEvent)) {
				assert.fail('Unexpected assertion error');
	...
	it('model delete text from two lines eventing', () => {
		let e: ModelRawContentChangedEvent | null = null;
		const disposable = thisModel.onDidChangeContentOrInjectedText((_e) => {
			if (e !== null || !(_e instanceof InternalModelContentChangeEvent)) {
				assert.fail('Unexpected assertion error');
	...
	it('model delete text from many lines eventing', () => {
		let e: ModelRawContentChangedEvent | null = null;
		const disposable = thisModel.onDidChangeContentOrInjectedText((_e) => {
			if (e !== null || !(_e instanceof InternalModelContentChangeEvent)) {
				assert.fail('Unexpected assertion error');
	...
	it('issue #46342: Maintain edit operation order in applyEdits', () => {
...
describe('Editor Model - Model Line Separators', () => {
	...
	it('Bug 13333:Model should line break on lonely CR too', () => {
...
describe('Editor Model - Words', () => {
	...
	it('getWordAtPosition at embedded language boundaries', () => {
	...
	it('issue #61296: VS code freezes when editing CSS file with emoji', () => {
