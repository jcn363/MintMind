...
describe('Editor Model - TextModel', () => {
	...
	it('TextModel does not use events internally', () => {
	...
	it('getValueLengthInRange different EOL', () => {
	...
	it('issue #44991: Wrong indentation size auto-detection', () => {
		assertGuess(true, 4, [
			'a = 10             # 0 space indent',
			'b = 5              # 0 space indent',
	...
	it('issue #55818: Broken indentation detection', () => {
		assertGuess(true, 2, [
			'',
			'/* REQUIRE */',
			'',
	...
	it('issue #70832: Broken indentation detection', () => {
		assertGuess(false, undefined, [
			'x',
			'x',
			'x',
	...
	it('issue #62143: Broken indentation detection', () => {
	...
	it('issue #84217: Broken indentation detection', () => {
		assertGuess(true, 4, [
			'def main():',
			'    print(\'hello\')',
		]);
	...
	it('validatePosition around high-low surrogate pairs 1', () => {
	...
	it('validatePosition around high-low surrogate pairs 2', () => {
	...
	it('validatePosition handle NaN.', () => {
	...
	it('issue #71480: validatePosition handle floats', () => {
		const m = createTextModel('line one\nline two');
	...
	it('issue #71480: validateRange handle floats', () => {
		const m = createTextModel('line one\nline two');
	...
	it('validateRange around high-low surrogate pairs 1', () => {
	...
	it('validateRange around high-low surrogate pairs 2', () => {
	...
	it('getLineFirstNonWhitespaceColumn', () => {
		const model = createTextModel([
			'asd',
			' asd',
			'\tasd',
	...
	it('getLineLastNonWhitespaceColumn', () => {
		const model = createTextModel([
			'asd',
			'asd ',
			'asd\t',
	...
	it('#50471. getValueInRange with invalid range', () => {
	...
	it('issue #168836: updating tabSize should also update indentSize when indentSize is set to "tabSize"', () => {
