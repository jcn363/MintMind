...
describe('Editor Model - Model Decorations', () => {
	...
	it('single character decoration', () => {
	...
	it('decoration range can be changed', () => {
		const decId = addDecoration(thisModel, 1, 2, 3, 2, 'myType');
		modelHasDecoration(thisModel, 1, 2, 3, 2, 'myType');
		thisModel.changeDecorations((changeAccessor) => {
	...
	it('decorations emit event on add', () => {
	...
	it('decorations emit event on change', () => {
		let listenerCalled = 0;
		const decId = addDecoration(thisModel, 1, 2, 3, 2, 'myType');
		const disposable = thisModel.onDidChangeDecorations((e) => {
			listenerCalled++;
	...
	it('decorations emit event on remove', () => {
		let listenerCalled = 0;
		const decId = addDecoration(thisModel, 1, 2, 3, 2, 'myType');
		const disposable = thisModel.onDidChangeDecorations((e) => {
			listenerCalled++;
	...
	it('decorations emit event when inserting one line text before it', () => {
		let listenerCalled = 0;
		addDecoration(thisModel, 1, 2, 3, 2, 'myType');
	...
	it('decorations do not emit event on no-op deltaDecorations', () => {
		let listenerCalled = 0;
	...
	it('decorations are updated when inserting one line text before it', () => {
		addDecoration(thisModel, 1, 2, 3, 2, 'myType');
		modelHasDecoration(thisModel, 1, 2, 3, 2, 'myType');
		thisModel.applyEdits([EditOperation.insert(new Position(1, 1), 'Hallo ')]);
	...
	it('decorations are updated when inserting one line text before it 2', () => {
	...
	it('decorations are updated when inserting multiple lines text before it', () => {
		addDecoration(thisModel, 1, 2, 3, 2, 'myType');
		modelHasDecoration(thisModel, 1, 2, 3, 2, 'myType');
	...
	it('decorations change when inserting text after them', () => {
		addDecoration(thisModel, 1, 2, 3, 2, 'myType');
		modelHasDecoration(thisModel, 1, 2, 3, 2, 'myType');
	...
	it('decorations are updated when inserting text inside', () => {
		addDecoration(thisModel, 1, 2, 3, 2, 'myType');
		modelHasDecoration(thisModel, 1, 2, 3, 2, 'myType');
	...
	it('decorations are updated when inserting text inside 2', () => {
		addDecoration(thisModel, 1, 2, 3, 2, 'myType');
		modelHasDecoration(thisModel, 1, 2, 3, 2, 'myType');
	...
	it('decorations are updated when inserting text inside 3', () => {
	...
	it('decorations are updated when inserting multiple lines text inside', () => {
		addDecoration(thisModel, 1, 2, 3, 2, 'myType');
		modelHasDecoration(thisModel, 1, 2, 3, 2, 'myType');
		thisModel.applyEdits([EditOperation.insert(new Position(1, 3), 'Hallo\nI\'m inserting multiple\nlines')]);
	...
	it('decorations are updated when deleting one line text before it', () => {
		addDecoration(thisModel, 1, 2, 3, 2, 'myType');
		modelHasDecoration(thisModel, 1, 2, 3, 2, 'myType');
	...
	it('decorations are updated when deleting multiple lines text before it', () => {
	...
	it('decorations are updated when deleting multiple lines text before it 2', () => {
	...
	it('decorations are updated when deleting text inside', () => {
	...
	it('decorations are updated when deleting text inside 2', () => {
		addDecoration(thisModel, 1, 2, 4, 1, 'myType');
		modelHasDecoration(thisModel, 1, 2, 4, 1, 'myType');
	...
	it('decorations are updated when deleting multiple lines text', () => {
		addDecoration(thisModel, 1, 2, 4, 1, 'myType');
		modelHasDecoration(thisModel, 1, 2, 4, 1, 'myType');
	...
	it('decorations are updated when changing EOL', () => {
	...
	it('removeAllDecorationsWithOwnerId can be called after model dispose', () => {
		const model = createTextModel('asd');
		model.dispose();
		model.removeAllDecorationsWithOwnerId(1);
	});

	it('removeAllDecorationsWithOwnerId works', () => {
...
describe('Decorations and editing', () => {
	...
	describe('delete', () => {
		describe('collapsed dec', () => {
			...
			it('edit.start < range.start && edit.end > range.end', () => {
				runTest(
					new Range(1, 4, 1, 4),
					new Range(1, 3, 1, 5), '',
					[
		...
		describe('non-collapsed dec', () => {
			...
			it('edit.start > range.start && edit.start < range.end && edit.end < range.end', () => {
				runTest(
					new Range(1, 4, 1, 9),
					new Range(1, 5, 1, 7), '',
					[
...
describe('deltaDecorations', () => {
	...
	it('issue #4317: editor.setDecorations doesn\'t update the hover message', () => {
	...
	it('model doesn\'t get confused with individual tracked ranges', () => {
		const model = createTextModel([
			'Hello world,',
			'How are you?'
		].join('\n'));
	...
	it('issue #16922: Clicking on link doesn\'t seem to do anything', () => {
		const model = createTextModel([
			'Hello world,',
			'How are you?',
			'Fine.',
	...
	it('issue #41492: URL highlighting persists after pasting over url', () => {
