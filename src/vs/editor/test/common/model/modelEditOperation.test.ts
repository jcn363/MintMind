...
describe('Editor Model - Model Edit Operation', () => {
	...
	it('Replace inline/multi line 1', () => {
		assertSingleEditOp(
	...
	it('Replace inline/multi line 2', () => {
		assertSingleEditOp(
	...
	it('Replace inline/multi line 3', () => {
		assertSingleEditOp(
	...
	it('Replace muli line/multi line', () => {
		assertSingleEditOp(
