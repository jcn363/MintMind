...
describe('LanguagesRegistry', () => {
	...
	it('output language does not have a name', () => {
	...
	it('language with alias does have a name', () => {
		const registry = new LanguagesRegistry(false);
	...
	it('language without alias gets a name', () => {
		const registry = new LanguagesRegistry(false);
	...
	it('bug #4360: f# not shown in status bar', () => {
		const registry = new LanguagesRegistry(false);
	...
	it('issue #5278: Extension cannot override language name anymore', () => {
		const registry = new LanguagesRegistry(false);
	...
	it('mimetypes are generated if necessary', () => {
		const registry = new LanguagesRegistry(false);
	...
	it('empty aliases array means no alias', () => {
		const registry = new LanguagesRegistry(false);
	...
	it('extensions of primary language registration come first', () => {
		const registry = new LanguagesRegistry(false);
