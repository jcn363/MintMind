...
describe('ModelService', () => {
	...
	it('EOL setting respected depending on root', () => {
	...
	it('_computeEdits no change', function () {
	...
	it('_computeEdits first line changed', function () {
	...
	it('_computeEdits EOL changed', function () {
	...
	it('_computeEdits EOL and other change 1', function () {
	...
	it('_computeEdits EOL and other change 2', function () {
	...
	it('does insertions in the middle of the document', () => {
		const file1 = [
			'line 1',
			'line 2',
			'line 3'
	...
	it('does insertions at the end of the document', () => {
		const file1 = [
			'line 1',
			'line 2',
			'line 3'
	...
	it('does insertions at the beginning of the document', () => {
		const file1 = [
			'line 1',
			'line 2',
			'line 3'
	...
	it('does insert, replace, and delete', () => {
		const file1 = [
			'line 1',
			'line 2',
			'line 3',
	...
	it('maintains undo for same resource and same content', () => {
	...
	it('maintains version id and alternative version id for same resource and same content', () => {
		const resource = URI.parse('file://test.txt');
	...
	it('does not maintain undo for same resource and different content', () => {
		const resource = URI.parse('file://test.txt');
	...
	it('setValue should clear undo stack', () => {
		const resource = URI.parse('file://test.txt');
