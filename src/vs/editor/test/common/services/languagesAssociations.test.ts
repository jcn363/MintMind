...
describe('LanguagesAssociations', () => {
	...
	it('Dynamically Register Text Mime', () => {
	...
	it('Mimes Priority - Longest Extension wins', () => {
		registerPlatformLanguageAssociation({ id: 'monaco', extension: '.monaco', mime: 'text/monaco' });
	...
	it('Mimes Priority - User configured wins', () => {
	...
	it('Mimes Priority - Pattern matches on path if specified', () => {
	...
	it('Mimes Priority - Last registered mime wins', () => {
		registerPlatformLanguageAssociation({ id: 'monaco', filepattern: '**/dot.monaco.xml', mime: 'text/monaco' });
