...
describe('EditorWebWorker', () => {
	...
	it('ICommonModel#validatePosition, issue #15882', function () {
	...
	it('MoreMinimal, merge adjacent edits', async function () {
	...
	it('MoreMinimal, issue #15385 newline changes only', function () {
	...
	it('MoreMinimal, issue #15385 newline changes and other', function () {
	...
	it('MoreMinimal, issue #15385 newline changes and other 2/2', function () {
	...
	it('computeHumanReadableDiff 1', async () => {
	...
	it('computeHumanReadableDiff 2', async () => {
		assert.deepStrictEqual(
			await testEdits(
				[
					'function it() {}'
				...
				[{
					text: 'function it(myParam: number) { console.log(myParam); }',
	...
	it('computeHumanReadableDiff 3', async () => {
		assert.deepStrictEqual(
			await testEdits(
				[
					'',
			...
			([{ range: '[2,1 -> 2,1]', text: 'function it(myParam: number) { console.log(myParam); }\n' }])
		);
	});

	it('computeHumanReadableDiff 4', async () => {
		assert.deepStrictEqual(
			await testEdits(
				[
					'function algorithm() {}',
	...
	it('[Bug] Getting Message "Overlapping ranges are not allowed" and nothing happens with Inline-Chat ', async function () {
	...
	it('ICommonModel#getValueInRange, issue #17424', function () {
	...
	it('textualSuggest, issue #17785', function () {
	...
	it('get words via iterator, issue #46930', function () {
