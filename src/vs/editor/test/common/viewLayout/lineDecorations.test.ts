...
describe('Editor ViewLayout - ViewLineParts', () => {
	...
	it('Bug 9827:Overlapping inline decorations can cause wrong inline class to be applied', () => {
	...
	it('issue #3462: no whitespace shown at the end of a decorated line', () => {
	...
	it('issue #3661: Link decoration bleeds to next line when wrapping', () => {
	...
	it('issue #37401: Allow both before and after decorations on empty line', () => {
		const result = LineDecoration.filter([
