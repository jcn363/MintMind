...
describe('Editor Modes - textToHtmlTokenizer', () => {
	...
	it('tokenizeLineToHTML handle spaces #35954', () => {
		const text = '  Ciao   hello world!';
		const lineTokens = new TestLineTokens([
			new TestLineToken(
				2,
	...
	it('tokenizeLineToHTML with tabs and non-zero startOffset #263387', () => {
