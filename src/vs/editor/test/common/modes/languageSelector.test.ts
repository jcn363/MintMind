...
describe('LanguageSelector', function () {
	...
	it('score, invalid selector', function () {
	...
	it('score hasAccessToAllModels', function () {
		const doc = {
	...
	it('score, notebookType', function () {
		const obj = {
	...
	it('Snippet choices lost #149363', function () {
	...
	it('Document selector match - unexpected result value #60232', function () {
		const selector = {
			language: 'json',
			scheme: 'file',
	...
	it('Document selector match - platform paths #99938', function () {
		const selector = {
			pattern: {
	...
	it('NotebookType without notebook', function () {
		const obj = {
