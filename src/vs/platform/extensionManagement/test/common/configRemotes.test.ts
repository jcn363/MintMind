...
describe('Config Remotes', () => {
	...
	it('Non allowed domains are anonymized', () => {
	...
	it('HTTPS remotes to be hashed', function () {
	...
	it('SSH remotes to be hashed', function () {
	...
	it('SCP-like remotes to be hashed', function () {
	...
	it('Local remotes to be hashed', function () {
	...
	it('Multiple remotes to be hashed', function () {
		const config = ['https://github.com/microsoft/vscode.git', 'https://git.example.com/gitproject.git'].map(remote).join(' ');
