...
describe('Extension Gallery Service', () => {
	...
	it('marketplace machine id', async () => {
	...
	it('sorting single extension version without target platform', async () => {
	...
	it('sorting single extension version with preferred target platform', async () => {
	...
	it('sorting single extension version with not compatible target platform', async () => {
	...
	it('sorting multiple extension versions without target platforms', async () => {
	...
	it('sorting multiple extension versions with target platforms - 1', async () => {
	...
	it('sorting multiple extension versions with target platforms - 2', async () => {
	...
	it('sorting multiple extension versions with target platforms - 3', async () => {
	...
	describe('filterLatestExtensionVersionsForTargetPlatform', () => {
		...
		it('should return single version when only one version provided', () => {
		...
		it('should filter out duplicate target platforms for release versions', () => {
		...
		it('should include one version per target platform for release versions', () => {
			const version1 = aExtensionVersion('1.0.0', TargetPlatform.WIN32_X64);
		...
		it('should separate release and pre-release versions', () => {
		...
		it('should filter duplicate pre-release versions by target platform', () => {
		...
		it('should handle versions without target platform (UNDEFINED)', () => {
		...
		it('should handle mixed release and pre-release versions across multiple platforms', () => {
		...
		it('should handle complex scenario with multiple versions and platforms', () => {
			const versions = [
		...
		it('should handle UNDEFINED platform interaction with specific platforms', () => {
		...
		it('should handle higher version with specific platform vs lower version with universal platform', () => {
		...
		it('should handle lower version with specific platform vs higher version with universal platform', () => {
		...
		it('should handle multiple specific platforms vs universal platform with version differences', () => {
		...
		it('should include universal platform when no specific platforms conflict', () => {
		...
		it('should preserve order of input when no filtering occurs', () => {
			const version1 = aExtensionVersion('1.0.0', TargetPlatform.WIN32_X64);
			const version2 = aExtensionVersion('1.0.0', TargetPlatform.DARWIN_X64);
