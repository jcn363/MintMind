...
describe('ExtensionDownloader Tests', () => {
	...
	it('download completes successfully if verification is disabled by options', async () => {
	...
	it('download completes successfully if verification is disabled because the module is not loaded', async () => {
	...
	it('download completes successfully if verification fails to execute', async () => {
	...
	it('download completes successfully if verification fails ', async () => {
	...
	it('download completes successfully if verification succeeds', async () => {
	...
	it('download completes successfully for unsigned extension', async () => {
		const testObject = aTestObject({ verificationResult: true });
	...
	it('download completes successfully for an unsigned extension even when signature verification throws error', async () => {
		const testObject = aTestObject({ verificationResult: 'error' });
