...
describe('Workspace', () => {
	...
	it('getFolder returns the folder with given uri', () => {
	...
	it('getFolder returns the folder if the uri is sub', () => {
	...
	it('getFolder returns the closest folder if the uri is sub', () => {
		const expected = new WorkspaceFolder({ uri: testFolderUri, name: '', index: 2 });
	...
	it('getFolder returns the folder even if the uri has query path', () => {
		const expected = new WorkspaceFolder({ uri: testFolderUri, name: '', index: 2 });
		const testObject = new Workspace('', [new WorkspaceFolder({ uri: mainFolderUri, name: '', index: 0 }), new WorkspaceFolder({ uri: URI.file('/src/code'), name: '', index: 1 }), expected], false, null, () => !isLinux);
	...
	it('getFolder returns null if the uri is not sub', () => {
	...
	it('toWorkspaceFolders with single absolute folder', () => {
	...
	it('toWorkspaceFolders with single relative folder', () => {
	...
	it('toWorkspaceFolders with single absolute folder with name', () => {
	...
	it('toWorkspaceFolders with multiple unique absolute folders', () => {
	...
	it('toWorkspaceFolders with multiple unique absolute folders with names', () => {
	...
	it('toWorkspaceFolders with multiple unique absolute and relative folders', () => {
	...
	it('toWorkspaceFolders with multiple absolute folders with duplicates', () => {
	...
	it('toWorkspaceFolders with multiple absolute and relative folders with duplicates', () => {
	...
	it('toWorkspaceFolders with multiple absolute and relative folders with invalid paths', () => {
