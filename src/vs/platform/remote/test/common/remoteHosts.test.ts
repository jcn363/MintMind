...
describe('remoteHosts', () => {
	...
	it('parseAuthorityWithOptionalPort hostname', () => {
	...
	it('parseAuthorityWithOptionalPort ipv4', () => {
	...
	it('parseAuthorityWithOptionalPort ipv6', () => {
	...
	it('issue #151748: Error: Remote authorities containing \'+\' need to be resolved!', () => {
