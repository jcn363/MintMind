...
describe('URI Identity', function () {
	...
	it('asCanonicalUri (casing)', function () {
	...
	it('asCanonicalUri (normalization)', function () {
		const a = URI.parse('foo://bar/bang');
		assertCanonical(a, a);
	...
	it('asCanonicalUri (keep fragement)', function () {
	...
	it.skip('[perf] CPU pegged after some builds #194853', function () {
