...
describe('MenuService', function () {
	...
	it('in group sorting, by title', function () {
	...
	it('in group sorting, by title and order', function () {
	...
	it('in group sorting, special: navigation', function () {
	...
	it('special MenuId palette', function () {
	...
	it('Extension contributed submenus missing with errors in output #155030', function () {
