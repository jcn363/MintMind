...
describe('CDP Accessibility Domain', () => {
	...
	it('empty tree returns empty string', () => {
	...
	it('paragraph with text conversion', () => {
		const nodes: AXNode[] = [
			{
				nodeId: 'node1',
				ignored: false,
	...
	it('really long paragraph should insert newlines at the space before 80 characters', () => {
		const longStr = [
...
`;
	...
	it('links to same page are not converted to markdown links', () => {
	...
	it('image without URL shows alt text', () => {
		const nodes: AXNode[] = [
			{
				nodeId: 'node1',
				ignored: false,
	...
	it('description list conversion', () => {
		const nodes: AXNode[] = [
			{
				nodeId: 'dl',
				ignored: false,
...
> With multiple lines`;
	...
	it('preformatted text conversion', () => {
		const nodes: AXNode[] = [
			{
				nodeId: 'node1',
				ignored: false,
				role: createAXValue('role', 'pre'),
				name: createAXValue('string', 'function it() {\n  return true;\n}')
			}
		];
...
`;
	...
	it('table with columnheader role (th elements)', () => {
		const nodes: AXNode[] = [
			{
				nodeId: 'table1',
				ignored: false,
...
`;
	...
	it('table with mixed cell types', () => {
		const nodes: AXNode[] = [
			{
				nodeId: 'table1',
				ignored: false,
