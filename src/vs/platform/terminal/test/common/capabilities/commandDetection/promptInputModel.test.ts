...
describe('PromptInputModel', () => {
	...
	it('basic input and execute', async () => {
		await writePromise('$ ');
		fireCommandStart();
	...
	it('should not fire onDidChangeInput events when nothing changes', async () => {
	...
	it('should fire onDidInterrupt followed by onDidFinish when ctrl+c is pressed', async () => {
		await writePromise('$ ');
		fireCommandStart();
		await assertPromptInput('|');
	...
	describe('ghost text', () => {
		...
		it('basic ghost text one word', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('ghost text with cursor navigation', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('ghost text with different foreground colors only', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('no ghost text when foreground color matches earlier text', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('ghost text detected when foreground color is unique at the end', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('no ghost text when background color matches earlier text', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('ghost text detected when background color is unique at the end', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('ghost text detected when bold style is unique at the end', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('no ghost text when earlier text has the same bold style', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('ghost text detected when italic style is unique at the end', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('no ghost text when earlier text has the same italic style', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('ghost text detected when underline style is unique at the end', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('no ghost text when earlier text has the same underline style', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('ghost text detected when strikethrough style is unique at the end', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('no ghost text when earlier text has the same strikethrough style', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		describe('With wrapping', () => {
			it('Fish ghost text in long line with wrapped content', async () => {
			...
			it('Pwsh ghost text in long line with wrapped content', async () => {
		...
		it('Does not detect right prompt as ghost text', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
	...
	describe('trailing whitespace', () => {
		it('cursor index calculation with whitespace', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('cursor index should not exceed command line length', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('whitespace preservation in cursor calculation', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('delete whitespace with backspace', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it.skip('track whitespace when ConPTY deletes whitespace unexpectedly', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
		...
		it('track whitespace beyond cursor', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
	...
	describe('multi-line', () => {
		...
		it('navigate left in multi-line', async () => {
		...
		it('navigate up in multi-line', async () => {
			return runWithFakedTimers({}, async () => {
				await writePromise('$ ');
				fireCommandStart();
				await assertPromptInput('|');
		...
		it('navigating up when first line contains invalid/stale trailing whitespace', async () => {
			await writePromise('$ ');
			fireCommandStart();
			await assertPromptInput('|');
	...
	describe('multi-line wrapped (no continuation prompt)', () => {
		it('basic wrapped line', async () => {
			return runWithFakedTimers({}, async () => {
				xterm.resize(5, 10);
	...
	describe('multi-line wrapped (continuation prompt)', () => {
		it('basic wrapped line', async () => {
			xterm.resize(5, 10);
	...
	describe('multi-line wrapped fish', () => {
		it('forward slash continuation', async () => {
			promptInputModel.setShellType(PosixShellType.Fish);
			await writePromise('$ ');
			await assertPromptInput('|');
		...
		it('newline with no continuation', async () => {
			promptInputModel.setShellType(PosixShellType.Fish);
			await writePromise('$ ');
			await assertPromptInput('|');
			await writePromise('[I] meganrogge@Megans-MacBook-Pro ~ (main|BISECTING)>');
	...
	describe('recorded sessions', () => {
		...
		describe('Windows 11 (10.0.22621.3447), pwsh 7.4.2, starship prompt 1.10.2', () => {
			it('input with ignored ghost text', async () => {
				return runWithFakedTimers({}, async () => {
					await replayEvents([
			...
			it('input with accepted and run ghost text', async () => {
				return runWithFakedTimers({}, async () => {
					await replayEvents([
						'[?25l[2J[m[H]0;C:\\Program Files\\WindowsApps\\Microsoft.PowerShell_7.4.2.0_x64__8wekyb3d8bbwe\\pwsh.exe[?25h',
						'[?25l[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K[H[?25h',
			...
			it('input, go to start (ctrl+home), delete word in front (ctrl+delete)', async () => {
				return runWithFakedTimers({}, async () => {
					await replayEvents([
						'[?25l[2J[m[H]0;C:\Program Files\WindowsApps\Microsoft.PowerShell_7.4.2.0_x64__8wekyb3d8bbwe\pwsh.exe[?25h',
						'[?25l[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K\r\n[K[H[?25h',
