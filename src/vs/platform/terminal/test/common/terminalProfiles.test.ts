...
describe('terminalProfiles', () => {
	...
	describe('createProfileSchemaEnums', () => {
		...
		it('should return a single entry when there is one profile', () => {
		...
		it('should show all profile information', () => {
			const profile: ITerminalProfile = {
				profileName: 'name',
				path: 'path',
				isDefault: true,
		...
		it('should return a multiple entries when there are multiple profiles', () => {
