...
describe('WindowsFinder', () => {
	...
	it('New window without folder when no windows exist', async () => {
	...
	it('Existing window with folder', async () => {
	...
	it('More specific existing window wins', async () => {
	...
	it('Workspace folder wins', async () => {
