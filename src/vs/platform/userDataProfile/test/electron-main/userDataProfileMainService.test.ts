...
describe('UserDataProfileMainService', () => {
	...
	it('set profile to a workspace', async () => {
	...
	it('set profile to a folder', async () => {
	...
	it('set profile to a window', async () => {
