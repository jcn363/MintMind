...
describe('UserDataProfileService (Common)', () => {
	...
	it('create profile with id, name and transient', async () => {
	...
	it('create transient profiles', async () => {
	...
	it('create transient profile when a normal profile with Temp is already created', async () => {
	...
	it('profiles include default profile with extension resource defined when transiet prrofile is created', async () => {
	...
	it('profiles include default profile with extension resource undefined when transiet prrofile is removed', async () => {
	...
	it('persist transient profile', async () => {
		const profile = await testObject.createTransientProfile();
	...
	it('persist transient profile (2)', async () => {
		const profile = await testObject.createProfile('id', 'name', { transient: true });
		await testObject.updateProfile(profile, { name: 'saved', transient: false });
	...
	it('save transient profile', async () => {
		const profile = await testObject.createTransientProfile();
	...
	it('profile using default profile for settings', async () => {
	...
	it('profile using default profile for keybindings', async () => {
	...
	it('profile using default profile for snippets', async () => {
	...
	it('profile using default profile for tasks', async () => {
	...
	it('profile using default profile for global state', async () => {
	...
	it('profile using default profile for extensions', async () => {
	...
	it('update profile using default profile for keybindings', async () => {
	...
	it('create profile with a workspace associates it to the profile', async () => {
	...
	it('associate workspace to a profile should update workspaces', async () => {
		const profile = await testObject.createProfile('id', 'name', {});
		const workspace = URI.file('/workspace1');
	...
	it('associate same workspace to a profile should not duplicate', async () => {
		const workspace = URI.file('/workspace1');
	...
	it('associate workspace to another profile should update workspaces', async () => {
		const workspace = URI.file('/workspace1');
	...
	it('unassociate workspace to a profile should update workspaces', async () => {
		const workspace = URI.file('/workspace1');
		const profile = await testObject.createProfile('id', 'name', {}, { id: workspace.path, uri: workspace });
	...
	it('update profile workspaces - add workspace', async () => {
		let profile = await testObject.createNamedProfile('name');
		const workspace = URI.file('/workspace1');
	...
	it('update profile workspaces - remove workspace', async () => {
		let profile = await testObject.createNamedProfile('name');
		const workspace = URI.file('/workspace1');
		profile = await testObject.updateProfile(profile, { workspaces: [workspace] });
	...
	it('update profile workspaces - replace workspace', async () => {
		let profile = await testObject.createNamedProfile('name');
	...
	it('update default profile workspaces - add workspace', async () => {
		const workspace = URI.file('/workspace1');
	...
	it('can create transient and persistent profiles with same name', async () => {
