...
describe.skip('File Watcher (parcel)', function () {
	...
	it('subsequent watch updates watchers (path)', async function () {
	...
	it('invalid path does not crash watcher', async function () {
		await watcher.watch([
	...
	it('subsequent watch updates watchers (excludes)', async function () {
	...
	it('subsequent watch updates watchers (includes)', async function () {
	...
	it('invalid folder does not explode', async function () {
	...
	it('should not exclude roots that do not overlap', async () => {
		if (isWindows) {
	...
	it('should remove sub-folders of other paths', async () => {
		if (isWindows) {
	...
	it('should ignore when everything excluded', async () => {
		assert.deepStrictEqual(await watcher.testRemoveDuplicateRequests(['/foo/bar', '/bar'], ['**', 'something']), []);
	});

	it('watching same or overlapping paths supported when correlation is applied', async () => {
		await watcher.watch([
	...
	it('deleting watched path emits watcher fail and delete event if correlated', async function () {
	...
	it('watch requests support suspend/resume (folder, does not exist in beginning, reusing watcher)', async () => {
	...
	it('watch requests support suspend/resume (folder, exist in beginning, reusing watcher)', async () => {
	...
	it('watch request reuses another recursive watcher even when requests are coming in at the same time', async function () {
	...
	it('event type filter', async function () {
