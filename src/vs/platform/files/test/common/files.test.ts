...
describe('Files', () => {
	...
	it('FileChangesEvent - basics', function () {
		const changes = [
	...
	it('FileChangesEvent - supports multiple changes on file tree', function () {
	...
	it('FileChangesEvent - correlation', function () {
	...
	it('isEqual (ignoreCase)', function () {
		testIsEqual(isEqual);
	...
	it('isParent (ignorecase)', function () {
		if (isWindows) {
	...
	it('isEqualOrParent (ignorecase)', function () {
