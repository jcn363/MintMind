...
describe('NotificationsList AccessibilityProvider', () => {
	...
	it('getAriaLabel includes severity prefix for Error notifications', () => {
	...
	it('getAriaLabel includes severity prefix for Warning notifications', () => {
	...
	it('getAriaLabel includes severity prefix for Info notifications', () => {
	...
	it('getAriaLabel includes source when present', () => {
	...
	it('severity prefix consistency', () => {
