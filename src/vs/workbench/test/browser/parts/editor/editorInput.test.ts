...
describe('EditorInput', () => {
	...
	it('Untpyed inputs properly match TextResourceEditorInput', () => {
	...
	it('Untyped inputs properly match FileEditorInput', () => {
	...
	it('Untyped inputs properly match MergeEditorInput', () => {
	...
	it('Untyped inputs properly match UntitledTextEditorInput', () => {
	...
	it('Untyped inputs properly match DiffEditorInput', () => {
