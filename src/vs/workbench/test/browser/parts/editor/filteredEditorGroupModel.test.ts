...
describe('FilteredEditorGroupModel', () => {
	...
	it('Sticky/Unsticky count', async () => {
	...
	it('Sticky/Unsticky stickyCount', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky isEmpty', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky editors', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky activeEditor', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky previewEditor', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky isSticky()', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky isPinned()', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky isActive()', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky getEditors()', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky getEditorByIndex()', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky indexOf()', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky isFirst()', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky isLast()', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky contains()', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky group information', async () => {
		const model = createEditorGroupModel();
	...
	it('Sticky/Unsticky isTransient()', async () => {
		const model = createEditorGroupModel();
