...
describe('EditorPane', () => {
	...
	it('Editor Pane Registration', function () {
	...
	it('Editor Pane Lookup favors specific class over superclass (match on specific class)', function () {
	...
	it('Editor Pane Lookup favors specific class over superclass (match on super class)', function () {
		const inst = workbenchInstantiationService(undefined, disposables);
	...
	it('Editor Input Serializer', function () {
	...
	it('EditorMemento - basics', function () {
	...
	it('EditorMemento - move', function () {
		const testGroup0 = new TestEditorGroupView(0);
	...
	it('EditoMemento - use with editor input', function () {
		const testGroup0 = new TestEditorGroupView(0);
	...
	it('EditoMemento - clear on editor dispose', function () {
		const testGroup0 = new TestEditorGroupView(0);
	...
	it('EditorMemento - workbench.editor.sharedViewState', function () {
		const testGroup0 = new TestEditorGroupView(0);
		const testGroup1 = new TestEditorGroupView(1);
	...
	it('WorkspaceTrustRequiredEditor', async function () {
