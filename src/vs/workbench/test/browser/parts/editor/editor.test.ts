...
describe('Workbench editor utils', () => {
	...
	it('EditorResourceAccessor - typed inputs', () => {
	...
	it('EditorResourceAccessor - untyped inputs', () => {
	...
	it('isEditorInputWithOptionsAndGroup', () => {
