...
export abstract class RequireInterceptor {
	...
	async install(): Promise<void> {
		...
		this.register(new MintMindNodeModuleFactory(this._apiFactory, extensionPaths, this._extensionRegistry, configProvider, this._logService));
...
class MintMindndNodeModuleFactory implements INodeModuleFactory {
