...
describe('ExtHostTelemetry', function () {
	...
	it('Validate sender instances', function () {
	...
	it('Ensure logger gets proper telemetry level during initialization', function () {
	...
	it('Simple log event to TelemetryLogger', function () {
	...
	it('Simple log event to TelemetryLogger with options', function () {
		const functionSpy: TelemetryLoggerSpy = { dataArr: [], exceptionArr: [], flushCalled: false };
	...
	it('Log error should get common properties #193205', function () {
		const functionSpy: TelemetryLoggerSpy = { dataArr: [], exceptionArr: [], flushCalled: false };
	...
	it('Ensure logger properly cleans PII', function () {
		const functionSpy: TelemetryLoggerSpy = { dataArr: [], exceptionArr: [], flushCalled: false };
	...
	it('Ensure output channel is logged to', function () {
