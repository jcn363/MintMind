...
describe('ExtHostLanguageFeatureCommands', function () {
	...
	it('WorkspaceSymbols, invalid arguments', function () {
		const promises = [
	...
	it('WorkspaceSymbols, back and forth', function () {
	...
	it('executeWorkspaceSymbolProvider should accept empty string, #39522', async function () {
	...
	// --- formatting
	it('executeFormatDocumentProvider, back and forth', async function () {
	...
	// --- rename
	it('vscode.prepareRename', async function () {
	...
	it('vscode.executeDocumentRenameProvider', async function () {
		disposables.push(extHost.registerRenameProvider(nullExtensionDescription, defaultSelector, new class implements vscode.RenameProvider {
			provideRenameEdits(document: vscode.TextDocument, position: vscode.Position, newName: string) {
				const edit = new types.WorkspaceEdit();
				edit.insert(document.uri, <types.Position>position, newName);
	...
	it('Definition, invalid arguments', function () {
		const promises = [
	...
	it('Definition, back and forth', function () {
	...
	it('Definition, back and forth (sorting & de-deduping)', function () {
	...
	it('Declaration, back and forth', function () {
	...
	it('Type Definition, invalid arguments', function () {
		const promises = [
	...
	it('Type Definition, back and forth', function () {
	...
	it('Implementation, invalid arguments', function () {
		const promises = [
	...
	it('Implementation, back and forth', function () {
	...
	it('Implementation Definition Link', () => {
		disposables.push(extHost.registerImplementationProvider(nullExtensionDescription, defaultSelector, <vscode.ImplementationProvider>{
	...
	it('reference search, back and forth', function () {
	...
	it('"vscode.executeDocumentHighlights" API has stopped returning DocumentHighlight[]#200056', async function () {
	...
	it('Outline, back and forth', function () {
	...
	it('vscode.executeDocumentSymbolProvider command only returns SymbolInformation[] rather than DocumentSymbol[] #57984', function () {
		disposables.push(extHost.registerDocumentSymbolProvider(nullExtensionDescription, defaultSelector, <vscode.DocumentSymbolProvider>{
			provideDocumentSymbols(): any {
				return [
	...
	it('Parameter Hints, back and forth', async () => {
	...
	it('"TypeError: e.onCancellationRequested is not a function" calling hover provider in Insiders #54174', function () {
	...
	it('Selection Range, back and forth', async function () {
	...
	it('CallHierarchy, back and forth', async function () {
	...
	it('prepareCallHierarchy throws TypeError if clangd returns empty result #137415', async function () {
	...
	it('TypeHierarchy, back and forth', async function () {
	...
	it('selectionRangeProvider on inner array always returns outer array #91852', async function () {
	...
	it('more element test of selectionRangeProvider on inner array always returns outer array #91852', async function () {
