...
describe('NotebookKernel', function () {
	...
	it('create/dispose kernel', async function () {
	...
	it('update kernel', async function () {
	...
	it('execute - simple createNotebookCellExecution', function () {
		const kernel = disposables.add(extHostNotebookKernels.createNotebookController(nullExtensionDescription, 'foo', '*', 'Foo'));
	...
	it('createNotebookCellExecution, must be selected/associated', function () {
		const kernel = disposables.add(extHostNotebookKernels.createNotebookController(nullExtensionDescription, 'foo', '*', 'Foo'));
		assert.throws(() => {
	...
	it('createNotebookCellExecution, cell must be alive', function () {
		const kernel = disposables.add(extHostNotebookKernels.createNotebookController(nullExtensionDescription, 'foo', '*', 'Foo'));
	...
	it('interrupt handler, cancellation', async function () {
	...
	it('set outputs on cancel', async function () {
	...
	it('set outputs on interrupt', async function () {
