...
describe('NotebookCell#Document', function () {
	...
	it('cell document is vscode.TextDocument', async function () {
	...
	it('cell document goes when notebook closes', async function () {
	...
	it('cell document is vscode.TextDocument after changing it', async function () {
	...
	it('cell document stays open when notebook is still open', async function () {
	...
	it('cell document goes when cell is removed', async function () {
	...
	it('ERR MISSING extHostDocument for notebook cell: #116711', async function () {
	...
	it('unset active notebook editor', function () {
	...
	it('change cell language triggers onDidChange events', async function () {
	...
	it('onDidChangeNotebook-event, cell changes', async function () {
	...
	it('onDidChangeNotebook-event, notebook metadata', async function () {
	...
	it('onDidChangeNotebook-event, froozen data', async function () {
	...
	it('change cell language and onDidChangeNotebookDocument', async function () {
	...
	it('change notebook cell document and onDidChangeNotebookDocument', async function () {
	...
	it('Compress multiple stdout stream output items (with support for terminal escape code -> \u001b[A)', async function () {
	...
	it('Compress multiple stdout stream output items (with support for terminal escape code -> \r character)', async function () {
		await replaceOutputs(1, '1', [{ mime: 'application/vnd.code.notebook.stdout', valueBytes: VSBuffer.fromString('foo') }]);
