...
describe('ExtHostDocumentData', () => {
	...
	it('save, when disposed', function () {
		let saved: URI;
	...
	it('read, when disposed', function () {
		data.dispose();
	...
	it('offsetAt, after remove', function () {
	...
	it('offsetAt, after replace', function () {
	...
	it('offsetAt, after insert line', function () {
	...
	it('offsetAt, after remove line', function () {
...
describe('ExtHostDocumentData updates line mapping', () => {
	...
	it('after deleting entire content', () => {
		testLineMappingAfterEvents([
			'This is line one',
			'and this is line number two',
			'it is followed by #3',
	...
	it('after replacing entire content', () => {
		testLineMappingAfterEvents([
			'This is line one',
			'and this is line number two',
			'it is followed by #3',
