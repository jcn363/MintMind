...
describe('ExtHostConfiguration', function () {
	...
	it('getConfiguration fails regression test 1.7.1 -> 1.8 #15552', function () {
	...
	it('can modify the returned configuration', function () {
	...
	it('Stringify returned configuration', function () {
	...
	it('cannot modify returned configuration', function () {
	...
	it('inspect in no workspace context', function () {
	...
	it('inspect in single root context', function () {
	...
	it('inspect in multi root context', function () {
		const workspace = new ConfigurationModel({
			'editor': {
				'wordWrap': 'bounded'
			}
	...
	it('inspect with language overrides', function () {
		const firstRoot = URI.file('foo1');
		const secondRoot = URI.file('foo2');
		const folders: [UriComponents, IConfigurationModel][] = [];
	...
	it('application is not set in inspect', () => {
	...
	it('getConfiguration vs get', function () {
	...
	it('update: no target passes null', function () {
	...
	it('update/section to key', function () {
	...
	it('update, what is #15834', function () {
		const shape = new RecordingShape();
		const allConfig = createExtHostConfiguration({
			'editor': {
				'formatOnSave': true
	...
	it('update/error-state not OK', function () {
	...
	it('configuration change event', (done) => {
	...
	it('get return instance of array value', function () {
