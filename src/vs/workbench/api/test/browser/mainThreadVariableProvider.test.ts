...
describe('MainThreadNotebookKernelVariableProvider', function () {
	...
	it('get variables from kernel', async function () {
	...
	it('get variables twice', async function () {
		await mainThreadKernels.addKernel('test-kernel');
	...
	it('gets all variables async', async function () {
		await mainThreadKernels.addKernel('test-kernel');
	...
	it('cancel while getting variables', async function () {
		await mainThreadKernels.addKernel('test-kernel');
