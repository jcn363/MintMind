...
describe('ExtHostTypes', function () {
	...
	it('Position, isAfter(OrEqual)?', function () {
		const p1 = new types.Position(1, 3);
		const p2 = new types.Position(1, 2);
		const p3 = new types.Position(0, 4);
	...
	it('Position, compareTo', function () {
		const p1 = new types.Position(1, 3);
		const p2 = new types.Position(1, 2);
		const p3 = new types.Position(0, 4);
	...
	it('Position, translate', function () {
		const p1 = new types.Position(1, 3);
	...
	it('Range, isEmpty|isSingleLine', function () {
		let range = new types.Range(1, 0, 0, 0);
	...
	it('Range, contains (no instanceof)', function () {
		const range = new types.Range(1, 1, 2, 11);
	...
	it('Range, intersection', function () {
		const range = new types.Range(1, 1, 2, 11);
		let res: types.Range;
	...
	it('WorkspaceEdit - keep order of text and file changes', function () {
	...
	it('WorkspaceEdit - two edits for one resource', function () {
		const edit = new types.WorkspaceEdit();
	...
	it('WorkspaceEdit - set with metadata accepts undefined', function () {
		const edit = new types.WorkspaceEdit();
		const uri = URI.parse('foo:bar');
	...
	it('SymbolInformation, old ctor', function () {
	...
	it('SnippetString, builder-methods', function () {
	...
	it('Snippet choices are incorrectly escaped/applied #180132', function () {
		{
	...
	it('SemanticTokensBuilder simple', () => {
	...
	it('SemanticTokensBuilder no modifier', () => {
		const builder = new types.SemanticTokensBuilder();
	...
	it('SemanticTokensBuilder out of order 1', () => {
		const builder = new types.SemanticTokensBuilder();
	...
	it('SemanticTokensBuilder with legend', () => {
	...
	it('FileDecoration#validate', function () {
	...
	it('runtime stable, type-def changed', function () {
