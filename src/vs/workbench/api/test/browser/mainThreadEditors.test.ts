...
describe('MainThreadEditors', () => {
	...
	it(`applyWorkspaceEdit returns false if model is changed by user`, () => {
	...
	it(`issue #54773: applyWorkspaceEdit checks model version in race situation`, () => {
	...
	it('applyWorkspaceEdit: noop eol edit keeps undo stack clean', async () => {
	...
	it(`applyWorkspaceEdit with only resource edit`, () => {
	...
	it('applyWorkspaceEdit can control undo/redo stack 1', async () => {
	...
	it('applyWorkspaceEdit can control undo/redo stack 2', async () => {
		const model = modelService.getModel(existingResource)!;
