...
describe('MainThreadDiagnostics', function () {
	...
	it('clear markers on dispose', function () {
	...
	it('OnDidChangeDiagnostics triggers twice on same diagnostics #136434', function () {
	...
	it('onDidChangeDiagnostics different behavior when "extensionKind" ui running on remote workspace #136955', function () {
		return runWithFakedTimers({}, async () => {
