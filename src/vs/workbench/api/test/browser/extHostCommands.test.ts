...
describe('ExtHostCommands', function () {
	...
	it('dispose calls unregister', function () {
	...
	it('dispose bubbles only once', function () {
	...
	it('execute with retry', async function () {
	...
	it('onCommand:abc activates extensions when executed from command palette, but not when executed programmatically with vscode.commands.executeCommand #150293', async function () {
