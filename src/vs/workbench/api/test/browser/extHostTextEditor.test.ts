...
describe('ExtHostTextEditor', () => {
	...
	it('API [bug]: registerTextEditorCommand clears redo stack even if no edits are made #55163', async function () {
		let applyCount = 0;
...
describe('ExtHostTextEditorOptions', () => {
	...
	it('can set tabSize to the same value', () => {
	...
	it('can change tabSize to positive integer', () => {
	...
	it('can change tabSize to positive float', () => {
	...
	it('can change tabSize to a string number', () => {
	...
	it('tabSize can request indentation detection', () => {
	...
	it('can set indentSize to the same value', () => {
	...
	it('can change indentSize to positive integer', () => {
	...
	it('can change indentSize to positive float', () => {
	...
	it('can change indentSize to a string number', () => {
	...
	it('indentSize can request to use tabSize', () => {
	...
	it('indentSize cannot request indentation detection', () => {
		// eslint-disable-next-line local/code-no-any-casts
	...
	it('ignores invalid indentSize 1', () => {
	...
	it('ignores invalid indentSize 2', () => {
	...
	it('ignores invalid indentSize 3', () => {
		// eslint-disable-next-line local/code-no-any-casts
	...
	it('ignores invalid indentSize 4', () => {
		// eslint-disable-next-line local/code-no-any-casts
	...
	it('can set insertSpaces to the same value', () => {
	...
	it('can set insertSpaces to boolean', () => {
	...
	it('can set insertSpaces to false string', () => {
		opts.value.insertSpaces = 'false';
		assertState(opts, {
			tabSize: 4,
			indentSize: 4,
	...
	it('can set insertSpaces to truey', () => {
	...
	it('insertSpaces can request indentation detection', () => {
	...
	it('can set cursorStyle to same value', () => {
	...
	it('can set lineNumbers to same value', () => {
