...
describe('ExtHostTypeConverter', function () {
	...
	it('MarkdownConvert - uris', function () {
	...
	it('NPM script explorer running a script from the hover does not work #65561', function () {
	...
	it('Notebook metadata is ignored when using Notebook Serializer #125716', function () {
	...
	it('NotebookCellOutputItem', function () {
