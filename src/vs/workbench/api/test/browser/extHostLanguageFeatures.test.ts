...
describe('ExtHostLanguageFeatures', function () {
	...
	it('DocumentSymbols, register/deregister', async () => {
	...
	it('DocumentSymbols, evil provider', async () => {
	...
	it('DocumentSymbols, data conversion', async () => {
		disposables.add(extHost.registerDocumentSymbolProvider(defaultExtension, defaultSelector, new class implements vscode.DocumentSymbolProvider {
			provideDocumentSymbols(): any {
				return [new types.SymbolInformation('test', types.SymbolKind.Field, new types.Range(0, 0, 0, 0))];
			}
	...
	it('Quick Outline uses a not ideal sorting, #138502', async function () {
		const symbols = [
	...
	it('CodeLens, evil provider', async () => {
	...
	it('CodeLens, do not resolve a resolved lens', async () => {
		return runWithFakedTimers({ useFakeTimers: true }, async () => {
			disposables.add(extHost.registerCodeLensProvider(defaultExtension, defaultSelector, new class implements vscode.CodeLensProvider {
				provideCodeLenses(): any {
	...
	it('CodeLens, missing command', async () => {
		return runWithFakedTimers({ useFakeTimers: true }, async () => {
			disposables.add(extHost.registerCodeLensProvider(defaultExtension, defaultSelector, new class implements vscode.CodeLensProvider {
				provideCodeLenses() {
					return [new types.CodeLens(new types.Range(0, 0, 0, 0))];
	...
	it('Definition, data conversion', async () => {
	...
	it('Definition, one or many', async () => {
	...
	it('Definition, registration order', async () => {
	...
	it('Definition, evil provider', async () => {
	...
	it('Declaration, data conversion', async () => {
	...
	it('Implementation, data conversion', async () => {
	...
	it('Type Definition, data conversion', async () => {
	...
	it('HoverProvider, word range at pos', async () => {
	...
	it('HoverProvider, given range', async () => {
	...
	it('HoverProvider, registration order', async () => {
		disposables.add(extHost.registerHoverProvider(defaultExtension, defaultSelector, new class implements vscode.HoverProvider {
			provideHover(): any {
	...
	it('HoverProvider, evil provider', async () => {
	...
	it('Occurrences, data conversion', async () => {
	...
	it('Occurrences, order 1/2', async () => {
	...
	it('Occurrences, order 2/2', async () => {
	...
	it('Occurrences, evil provider', async () => {
	...
	it('References, registration order', async () => {
	...
	it('References, data conversion', async () => {
	...
	it('References, evil provider', async () => {
	...
	it('Quick Fix, command data conversion', async () => {
		return runWithFakedTimers({ useFakeTimers: true }, async () => {
	...
	it('Quick Fix, code action data conversion', async () => {
		return runWithFakedTimers({ useFakeTimers: true }, async () => {
			disposables.add(extHost.registerCodeActionProvider(defaultExtension, defaultSelector, {
	...
	it('Cannot read property \'id\' of undefined, #29469', async () => {
		return runWithFakedTimers({ useFakeTimers: true }, async () => {
	...
	it('Quick Fix, evil provider', async () => {
		return runWithFakedTimers({ useFakeTimers: true }, async () => {
			disposables.add(extHost.registerCodeActionProvider(defaultExtension, defaultSelector, new class implements vscode.CodeActionProvider {
				provideCodeActions(): any {
					throw new Error('evil');
	...
	it('Navigate types, evil provider', async () => {
	...
	it('Navigate types, de-duplicate results', async () => {
	...
	it('Rename, evil provider 0/2', async () => {
	...
	it('Rename, evil provider 1/2', async () => {
	...
	it('Rename, evil provider 2/2', async () => {
	...
	it('Multiple RenameProviders don\'t respect all possible PrepareRename handlers 1/2, #98352', async function () {
	...
	it('Multiple RenameProviders don\'t respect all possible PrepareRename handlers 2/2, #98352', async function () {
	...
	it('Parameter Hints, order', async () => {
	...
	it('Parameter Hints, evil provider', async () => {
	...
	it('Suggest, evil provider', async () => {
		return runWithFakedTimers({ useFakeTimers: true }, async () => {
			disposables.add(extHost.registerCompletionItemProvider(defaultExtension, defaultSelector, new class implements vscode.CompletionItemProvider {
				provideCompletionItems(): any {
					throw new Error('evil');
	...
	it('Suggest, CompletionList', async () => {
		return runWithFakedTimers({ useFakeTimers: true }, async () => {
			disposables.add(extHost.registerCompletionItemProvider(defaultExtension, defaultSelector, new class implements vscode.CompletionItemProvider {
				provideCompletionItems(): any {
	...
	it('Format Doc, data conversion', async () => {
	...
	it('Format Doc, evil provider', async () => {
		disposables.add(extHost.registerDocumentFormattingEditProvider(defaultExtension, defaultSelector, new class implements vscode.DocumentFormattingEditProvider {
			provideDocumentFormattingEdits(): any {
				throw new Error('evil');
			}
	...
	it('Format Range, data conversion', async () => {
	...
	it('Format Range, + format_doc', async () => {
		disposables.add(extHost.registerDocumentRangeFormattingEditProvider(defaultExtension, defaultSelector, new class implements vscode.DocumentRangeFormattingEditProvider {
			provideDocumentRangeFormattingEdits(): any {
	...
	it('Format Range, evil provider', async () => {
		disposables.add(extHost.registerDocumentRangeFormattingEditProvider(defaultExtension, defaultSelector, new class implements vscode.DocumentRangeFormattingEditProvider {
			provideDocumentRangeFormattingEdits(): any {
				throw new Error('evil');
			}
	...
	it('Format on Type, data conversion', async () => {
	...
	it('Links, data conversion', async () => {
	...
	it('Document colors, data conversion', async () => {
	...
	it('Selection Ranges, data conversion', async () => {
	...
	it('Selection Ranges, bad data', async () => {
