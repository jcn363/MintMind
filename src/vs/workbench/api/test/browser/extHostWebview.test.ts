...
describe('ExtHostWebview', () => {
	...
	it('Cannot register multiple serializers for the same view type', async () => {
	...
	it('asWebviewUri for local file paths', () => {
	...
	it('asWebviewUri for remote file paths', () => {
	...
	it('asWebviewUri for remote with / and + in name', () => {
		const webview = createWebview(rpcProtocol, /* remoteAuthority */ 'remote');
	...
	it('asWebviewUri for remote with port in name', () => {
		const webview = createWebview(rpcProtocol, /* remoteAuthority */ 'remote');
