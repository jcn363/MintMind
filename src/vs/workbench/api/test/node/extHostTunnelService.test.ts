...
const processes: { pid: number; cwd: string; cmd: string }[] = [
	...
	{
		pid: 2504,
		cwd: '/mnt/c/Users/alros/AppData/Local/Programs/Microsoft MintMind Insiders',
	...
	},
	{
		pid: 286,
		cwd: '/mnt/c/Users/alros/AppData/Local/Programs/Microsoft MintMind Insiders',
		cmd: 'sh-c\"$MINTMIND_WSL_EXT_LOCATION/ scripts / wslServer.sh\" bc13785d3dd99b4b0e9da9aed17bb79809a50804 insider .vscode-server-insiders 0  '
	},
	{
		pid: 287,
		cwd: '/mnt/c/Users/alros/AppData/Local/Programs/Microsoft MintMind Insiders',
...
describe('ExtHostTunnelService', () => {
	...
	it('loadConnectionTable', function () {
	...
	it('loadListeningPorts', function () {
