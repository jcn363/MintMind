...
describe('InternalTerminalShellIntegration', () => {
	...
	it('different execution unexpectedly ended', async () => {
	...
	describe('executeCommand', () => {
		it('^C to clear previous command', async () => {
		...
		it('multi-line command line', async () => {
			const commandLine = 'foo\nbar';
			const apiRequestedExecution = si.requestNewShellExecution(cmdLine(commandLine), undefined);
		...
		it('multi-line command with long second command', async () => {
		...
		it('multi-line command comment followed by long second command', async () => {
		...
		it('4 multi-line commands with output', async () => {
