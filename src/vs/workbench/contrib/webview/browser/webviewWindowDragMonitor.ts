...
/**
 * Allows webviews to monitor when an element in the MintMind editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. MintMind needs to see this
