 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in MintMind UI).
 */
 ...
 * to represent terminals that appear in other parts of the MintMind UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their MintMind OSC `SetMarker`
