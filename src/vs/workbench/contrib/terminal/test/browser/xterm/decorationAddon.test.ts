...
describe('DecorationAddon', () => {
	...
	describe('registerDecoration', () => {
		...
		it('should return decoration when marker has not been disposed of', async () => {
		...
		it('should return decoration with mark properties', async () => {
			const marker = xterm.registerMarker(2);
