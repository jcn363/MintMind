...
describe('Workbench - TerminalStatusList', () => {
	...
	it('onDidChangePrimaryStatus', async () => {
	...
	it('primary is not updated to status without an icon', async () => {
	...
	it('add should remove animation', () => {
		statusesEqual(list, []);
	...
	it('add should fire onDidRemoveStatus if same status id with a different object reference was added', () => {
