...
describe('terminalUri', () => {
	...
	describe('getTerminalResourcesFromDragEvent', () => {
		it('should give undefined when no terminal resources is in event', () => {
			deepStrictEqual(
				getTerminalResourcesFromDragEvent(fakeDragEvent(''))?.map(e => e.toString()),
				undefined
			);
		});
		it('should give undefined when an empty terminal resources array is in event', () => {
			deepStrictEqual(
				getTerminalResourcesFromDragEvent(fakeDragEvent('[]'))?.map(e => e.toString()),
				undefined
			);
		});
		it('should return terminal resource when event contains one', () => {
			deepStrictEqual(
		...
		it('should return multiple terminal resources when event contains multiple', () => {
			deepStrictEqual(
	...
	describe('getInstanceFromResource', () => {
		...
		it('should return a result if there is a match', () => {
