...
describe('Terminal Events', () => {
	...
	describe('createInstanceCapabilityEventMultiplexer', () => {
		it('should handle existing instances with capabilities', () => {
		...
		it('should handle instances without capabilities', () => {
			const capabilities = store.add(new TerminalCapabilityStore());
			const instance = createMockTerminalInstance(1, capabilities);
			const onAddInstance = store.add(new Emitter<ITerminalInstance>());
			const onRemoveInstance = store.add(new Emitter<ITerminalInstance>());
		...
		it('should handle adding new instances', () => {
			const onAddInstance = store.add(new Emitter<ITerminalInstance>());
			const onRemoveInstance = store.add(new Emitter<ITerminalInstance>());
		...
		it('should handle adding capabilities to existing instances', () => {
			const capabilities = store.add(new TerminalCapabilityStore());
		...
		it('should handle removing capabilities from existing instances', () => {
			const capability = store.add(new MockCwdDetectionCapability());
			const capabilities = store.add(new TerminalCapabilityStore());
			capabilities.add(TerminalCapability.CwdDetection, capability);
		...
		it('should handle multiple instances with same capability', () => {
		...
		it('should handle empty current instances array', () => {
			const onAddInstance = store.add(new Emitter<ITerminalInstance>());
			const onRemoveInstance = store.add(new Emitter<ITerminalInstance>());
