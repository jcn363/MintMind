...
describe('Workbench - TerminalService', () => {
	...
	describe('safeDisposeTerminal', () => {
		...
		it('should not show prompt when confirmOnKill is never', async () => {
		...
		it('should not show prompt when any terminal editor is closed (handled by editor itself)', async () => {
		...
		it('should not show prompt when confirmOnKill is editor and panel terminal is closed', async () => {
			await setConfirmOnKill(configurationService, 'editor');
			terminalService.safeDisposeTerminal({
				target: TerminalLocation.Panel,
				hasChildProcesses: true,
		...
		it('should show prompt when confirmOnKill is panel and panel terminal is closed', async () => {
		...
		it('should show prompt when confirmOnKill is always and panel terminal is closed', async () => {
			await setConfirmOnKill(configurationService, 'always');
			// No child process cases
			dialogService.setConfirmResult({ confirmed: false });
			terminalService.safeDisposeTerminal({
