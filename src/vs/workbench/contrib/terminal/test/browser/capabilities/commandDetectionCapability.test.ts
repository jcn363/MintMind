...
describe('CommandDetectionCapability', () => {
	...
	it('should not add commands when no capability methods are triggered', async () => {
	...
	it('should add commands for expected capability method calls', async () => {
	...
	it('should trim the command when command executed appears on the following line', async () => {
	...
	describe('cwd', () => {
		it('should add cwd to commands when it\'s set', async () => {
		...
		it('should add old cwd to commands if no cwd sequence is output', async () => {
			await printStandardCommand('$ ', 'echo foo', 'foo', '/home', 0);
		...
		it('should use an undefined cwd if it\'s not set initially', async () => {
			await printStandardCommand('$ ', 'echo foo', 'foo', undefined, 0);
