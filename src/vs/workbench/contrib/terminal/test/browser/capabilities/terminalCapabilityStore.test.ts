...
describe('TerminalCapabilityStore', () => {
	...
	it('should fire events when capabilities are added', () => {
	...
	it('should fire events when capabilities are removed', async () => {
	...
	it('has should return whether a capability is present', () => {
	...
	it('items should reflect current state', () => {
...
describe('TerminalCapabilityStoreMultiplexer', () => {
	...
	it('should fire events when capabilities are enabled', async () => {
		assertEvents(addEvents, []);
	...
	it('should fire events when capabilities are disabled', async () => {
		assertEvents(removeEvents, []);
		multiplexer.add(store1);
		multiplexer.add(store2);
		store1.add(TerminalCapability.CwdDetection, {} as unknown as ICwdDetectionCapability);
	...
	it('should fire events when stores are added', async () => {
		assertEvents(addEvents, []);
		store1.add(TerminalCapability.CwdDetection, {} as unknown as ICwdDetectionCapability);
		assertEvents(addEvents, []);
		store2.add(TerminalCapability.NaiveCwdDetection, {} as unknown as INaiveCwdDetectionCapability);
	...
	it('items should return items from all stores', () => {
