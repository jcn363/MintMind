...
describe('Workbench - TerminalInstance', () => {
	...
	describe('TerminalInstance', () => {
		...
		it('should create an instance of TerminalInstance with env from default profile', async () => {
		...
		it('should preserve title for task terminals', async () => {
			const instantiationService = workbenchInstantiationService({
				configurationService: () => new TestConfigurationService({
					files: {},
					terminal: {
	...
	describe('parseExitResult', () => {
		it('should return no message for exit code = undefined', () => {
			deepStrictEqual(
		...
		it('should return no message for exit code = 0', () => {
			deepStrictEqual(
		...
		it('should return friendly message when executable is specified for non-zero exit codes', () => {
			deepStrictEqual(
		...
		it('should return friendly message when executable and args are specified for non-zero exit codes', () => {
			deepStrictEqual(
		...
		it('should return friendly message when executable and arguments are omitted for non-zero exit codes', () => {
			deepStrictEqual(
		...
		it('should format conpty failure code 267', () => {
			deepStrictEqual(
		...
		it('should format conpty failure code 1260', () => {
			deepStrictEqual(
		...
		it('should format generic failures', () => {
			deepStrictEqual(
	...
	describe('TerminalLabelComputer', () => {
		...
		it('should provide cwdFolder for all cwds only when in multi-root', () => {
		...
		it('should hide cwdFolder in single folder workspaces when cwd matches the workspace\'s default cwd even when slashes differ', async () => {
	...
	describe('getCwdResource', () => {
		...
		it('should return undefined when no CwdDetection capability', async () => {
		...
		it('should return undefined when CwdDetection capability returns no cwd', async () => {
		...
		it('should return URI.file for local terminal when file exists', async () => {
		...
		it('should use pathService.fileURI for remote terminal', async () => {
		...
		it('should handle empty cwd string', async () => {
