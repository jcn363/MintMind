...
describe('Workbench - TerminalInstanceService', () => {
	...
	describe('convertProfileToShellLaunchConfig', () => {
		it('should return an empty shell launch config when undefined is provided', () => {
		...
		it('should return the same shell launch config when provided', () => {
			deepStrictEqual(
		...
		it('should convert a provided profile to a shell launch config', () => {
			deepStrictEqual(
				terminalInstanceService.convertProfileToShellLaunchConfig({
					profileName: 'abc',
					path: '/foo',
		...
		it('should respect overrideName in profile', () => {
			deepStrictEqual(
				terminalInstanceService.convertProfileToShellLaunchConfig({
					profileName: 'abc',
					path: '/foo',
