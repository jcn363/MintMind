...
describe('Workbench - TerminalConfigurationService', () => {
	...
	describe('config', () => {
		it('should update on any change to terminal.integrated', () => {
		...
		describe('onConfigChanged', () => {
			it('should fire on any change to terminal.integrated', async () => {
	...
	describe('configFontIsMonospace', () => {
		it('isMonospace monospace', () => {
			const terminalConfigurationService = createTerminalConfigationService({
				terminal: {
					integrated: {
		...
		it('isMonospace monospace falls back to editor.fontFamily', () => {
			const terminalConfigurationService = createTerminalConfigationService({
				editor: {
					fontFamily: 'monospace'
				},
		...
		it('isMonospace sans-serif falls back to editor.fontFamily', () => {
			const terminalConfigurationService = createTerminalConfigationService({
				editor: {
					fontFamily: 'sans-serif'
				},
		...
		it('isMonospace serif falls back to editor.fontFamily', () => {
			const terminalConfigurationService = createTerminalConfigationService({
				editor: {
					fontFamily: 'serif'
				},
