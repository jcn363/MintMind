...
describe('EnvironmentVariable - EnvironmentVariableService', () => {
	...
	it('should persist collections to the storage service and be able to restore from them', () => {
	...
	describe('mergedCollection', () => {
		it('should overwrite any other variable with the first extension that replaces', () => {
		...
		it('should correctly apply the environment values from multiple extension contributions in the correct order', async () => {
			const collection1 = new Map<string, IEnvironmentVariableMutator>();
			const collection2 = new Map<string, IEnvironmentVariableMutator>();
			const collection3 = new Map<string, IEnvironmentVariableMutator>();
			collection1.set('A-key', { value: ':a1', type: EnvironmentVariableMutatorType.Append, variable: 'A' });
		...
		it('should correctly apply the workspace specific environment values from multiple extension contributions in the correct order', async () => {
