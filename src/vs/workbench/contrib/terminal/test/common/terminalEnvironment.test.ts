...
describe('Workbench - TerminalEnvironment', () => {
	...
	describe('addTerminalEnvironmentKeys', () => {
		it('should set expected variables', () => {
		...
		it('should use language variant for LANG that is provided in locale', () => {
			const env: { [key: string]: any } = {};
		...
		it('should fallback to en_US when no locale is provided', () => {
		...
		it('should fallback to en_US when an invalid locale is provided', () => {
		...
		it('should override existing LANG', () => {
	...
	describe('getLangEnvVariable', () => {
		...
		it('should fallback to default language variants when variant isn\'t provided', () => {
		...
		it('should set language variant based on full locale', () => {
	...
	describe('mergeEnvironments', () => {
		...
		it('null values should delete keys from the parent env', () => {
			const parent = {
				a: 'b',
				c: 'd'
			};
	...
	describe('getCwd', () => {
		...
		it('should fall back for relative a custom cwd that doesn\'t have a workspace', async () => {
			assertPathsMatch(await getCwd({ executable: undefined, args: [] }, '/userHome/', undefined, undefined, 'foo'), '/userHome/');
			assertPathsMatch(await getCwd({ executable: undefined, args: [] }, '/userHome/', undefined, undefined, './foo'), '/userHome/');
			assertPathsMatch(await getCwd({ executable: undefined, args: [] }, '/userHome/', undefined, undefined, '../foo'), '/userHome/');
		});

		it('should ignore custom cwd when told to ignore', async () => {
	...
	describe('createTerminalEnvironment', () => {
		...
		it('should retain variables equal to the empty string', async () => {
			deepStrictEqual(
	...
	describe('formatUriForShellDisplay', () => {
		it('Wsl', async () => {
