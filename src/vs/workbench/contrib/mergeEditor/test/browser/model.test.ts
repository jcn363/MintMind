...
describe('merge editor model', () => {
	...
	it('can merge word changes', async () => {
		await testMergeModel(
			{
				'languageId': 'plaintext',
				'base': 'hello',
	...
	it('can combine insertions at end of document', async () => {
		await testMergeModel(
			{
				'languageId': 'plaintext',
				'base': 'Zürich\nBern\nBasel\nChur\nGenf\nThun',
	...
	it('auto-solve equal edits', async () => {
		await testMergeModel(
			{
