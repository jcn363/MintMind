...
describe('MCP - Sampling Log', () => {
	...
	it('logs a single request', async () => {
		log.add(
			fakeServer,
	...
	it('logs multiple requests on the same day', async () => {
		// First request
		log.add(
			fakeServer,
	...
	it('shifts bins when adding requests on different days', async () => {
	...
	it('limits the number of stored requests', async () => {
