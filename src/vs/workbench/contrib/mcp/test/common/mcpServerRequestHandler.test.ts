...
describe('Workbench - MCP - ServerRequestHandler', () => {
	...
	it('should send and receive JSON-RPC requests', async () => {
		// Setup request
	...
	it('should handle roots list requests', async () => {
		// Set roots
		handler.roots = [
	...
	it('should handle cancelled notification from server', async () => {
		// Setup request
		const requestPromise = handler.listResources();
	...
	it('should dispose properly and cancel pending requests', async () => {
	...
	it('should handle connection error by cancelling requests', async () => {
		// Setup request
		const requestPromise = handler.listResources();
