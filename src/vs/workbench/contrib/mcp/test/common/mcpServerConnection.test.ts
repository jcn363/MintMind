...
describe('Workbench - MCP - ServerConnection', () => {
	...
	it('should start and set state to Running when transport succeeds', async () => {
	...
	it('should not restart if already starting', async () => {
		// Create server connection
		const connection = instantiationService.createInstance(
			McpServerConnection,
			collection,
	...
	it('should log transport messages', async () => {
	...
	it('should correctly handle transitions to and from error state', async () => {
		// Create server connection
		const connection = instantiationService.createInstance(
			McpServerConnection,
			collection,
