...
describe('StarTrie', () => {
	...
	it('does added extension nesting', () => {
	...
	it('does general bidirectional suffix matching', () => {
		const t = new ExplorerFileNestingTrie([
			['*-vsdoc.js', ['${capture}.js']],
	...
	it('does general bidirectional prefix matching', () => {
		const t = new ExplorerFileNestingTrie([
			['vsdoc-*.js', ['${capture}.js']],
	...
	it('does general bidirectional general matching', () => {
		const t = new ExplorerFileNestingTrie([
	...
	it('does extension specific path segment matching', () => {
		const t = new ExplorerFileNestingTrie([
			['*.js', ['${capture}.*.js']],
		]);
	...
	it('added segment matcher (old format)', () => {
		const t = new ExplorerFileNestingTrie([
			['*', ['$(basename).*.$(extname)']],
		]);
