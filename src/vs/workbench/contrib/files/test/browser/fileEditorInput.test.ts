...
describe('Files - FileEditorInput', () => {
	...
	it('reports as untitled without supported file scheme', async function () {
	...
	it('reports as readonly with readonly file scheme', async function () {
	...
	it('preferred resource', function () {
	...
	it('preferred language', async function () {
	...
	it('preferred contents', async function () {
	...
	it('getEncoding/setEncoding', async function () {
	...
	it('resolve handles binary files', async function () {
		const input = createFileInput(toResource.call(this, '/foo/bar/updatefile.js'));
	...
	it('resolve throws for too large files', async function () {
		const input = createFileInput(toResource.call(this, '/foo/bar/updatefile.js'));
	...
	it('attaches to model when created and reports dirty', async function () {
		const input = createFileInput(toResource.call(this, '/foo/bar/updatefile.js'));
	...
	it('force open text/binary', async function () {
		const input = createFileInput(toResource.call(this, '/foo/bar/updatefile.js'));
	...
	it('file editor serializer', async function () {
	...
	it('preferred name/description', async function () {
	...
	it('reports readonly changes', async function () {
		const input = createFileInput(toResource.call(this, '/foo/bar/updatefile.js'));
