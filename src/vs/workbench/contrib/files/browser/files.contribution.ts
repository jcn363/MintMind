...
configurationRegistry.registerConfiguration({
	...
	'properties': {
		...
		'files.useRustFileIO': {
			'type': 'boolean',
			'default': !isWeb, // Enable by default in dev builds (non-web)
			'markdownDescription': nls.localize('useRustFileIO', "Enables the use of Rust-based file I/O operations for improved performance. When disabled, falls back to Node.js file operations."),
		}
	}
});
