...
describe('Logs Parsing', () => {
	...
	it('should parse log entry with all components', () => {
	...
	it('should parse multi-line log entry', () => {
		const text = [
	...
	it('should parse log entry without category', () => {
	...
	it('should handle last line of file', () => {
	...
	it('should parse multi-line log entry with empty lines', () => {
		const text = [
