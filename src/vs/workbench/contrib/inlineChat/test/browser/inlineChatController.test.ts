...
describe('InlineChatController', function () {
	...
	it('creation, not showing anything', function () {
		ctrl = instaService.createInstance(TestController, editor);
		assert.ok(ctrl);
		assert.strictEqual(ctrl.getWidgetPosition(), undefined);
	});

	it('run (show/hide)', async function () {
		ctrl = instaService.createInstance(TestController, editor);
	...
	it('wholeRange does not expand to whole lines, editor selection default', async function () {
	...
	it('typing outside of wholeRange finishes session', async function () {
	...
	it('\'whole range\' isn\'t updated for edits outside whole range #4346', async function () {
	...
	it('Stuck inline chat widget #211', async function () {
	...
	it('[Bug] Inline Chat\'s streaming pushed broken iterations to the undo stack #2403', async function () {
	...
	it.skip('UI is streaming edits minutes after the response is finished #3345', async function () {
	...
	it('escape doesn\'t remove code added from inline editor chat #3523 1/2', async function () {
	...
	it('escape doesn\'t remove code added from inline editor chat #3523, 2/2', async function () {
	...
	it('cancel while applying streamed edits should close the widget', async function () {
	...
	it('re-run should discard pending edits', async function () {
	...
	it('Retry undoes all changes, not just those from the request#5736', async function () {
	...
	it('moving inline chat to another model undoes changes', async function () {
		const text = [
			'eins\n',
			'zwei\n'
		];
	...
	it('moving inline chat to another model undoes changes (2 requests)', async function () {
		const text = [
			'eins\n',
			'zwei\n'
		];
	...
	it.skip('Clicking "re-run without /doc" while a request is in progress closes the widget #5997', async function () {
	...
	it('Re-run without after request is done', async function () {
	...
	it('Inline: Pressing Rerun request while the response streams breaks the response #5442', async function () {
	...
	it('Stopping/cancelling a request should NOT undo its changes', async function () {
	...
	it('Apply Edits from existing session w/ edits', async function () {
	...
	it('Undo on error (2 rounds)', async function () {
	...
	it('Inline chat "discard" button does not always appear if response is stopped #228030', async function () {
	...
	it('Restore doesn\'t edit on errored result', async function () {
