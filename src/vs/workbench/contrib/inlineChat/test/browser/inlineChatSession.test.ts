...
describe('InlineChatSession', function () {
	...
	it('Create, release', async function () {
	...
	it('HunkData, info', async function () {
	...
	it('HunkData, accept', async function () {
	...
	it('HunkData, reject', async function () {
	...
	it('HunkData, N rounds', async function () {
	...
	it('HunkData, (mirror) edit before', async function () {
	...
	it('HunkData, (mirror) edit after', async function () {
	...
	it('HunkData, (mirror) edit inside ', async function () {
	...
	it('HunkData, (mirror) edit after dicard ', async function () {
	...
	it('HunkData, (mirror) edit after, multi turn', async function () {
	...
	it('HunkData, (mirror) edit after, multi turn 2', async function () {
	...
	it('HunkData, accept, discardAll', async function () {
	...
	it('HunkData, discardAll return undo edits', async function () {
	...
	it('Pressing Escape after inline chat errored with "response filtered" leaves document dirty #7764', async function () {

		const origValue = `class Foo {
	private onError(error: string): void {
		if (/The request timed out|The network connection was lost/i.it(error)) {
			return;
		}
	...
	it('Apply Code\'s preview should be easier to undo/esc #7537', async function () {
