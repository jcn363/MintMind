...
describe('ExternalUriOpenerService', () => {
	...
	it('Should not open if there are no openers', async () => {
	...
	it('Should prompt if there is at least one enabled opener', async () => {
	...
	it('Should automatically pick single preferred opener without prompt', async () => {
		const externalUriOpenerService = disposables.add(instantiationService.createInstance(ExternalUriOpenerService));
