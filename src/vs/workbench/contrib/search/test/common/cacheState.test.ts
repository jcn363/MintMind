...
describe('FileQueryCacheState', () => {
	...
	it('reuse old cacheKey until new cache is loaded', async function () {
	...
	it('do not spawn additional load if previous is still loading', async function () {
	...
	it('do not use previous cacheKey if query changed', async function () {
	...
	it('dispose propagates', async function () {
	...
	it('keep using old cacheKey when loading fails', async function () {
