...
describe('PromptsService', () => {
	...
	describe('findInstructionFilesFor', () => {
		afterEach(() => {
			sinon.restore();
		});

		it('finds correct instruction files', async () => {
		...
		it('copilot-instructions and AGENTS.md', async () => {
	...
	describe('getCustomAgents', () => {
		...
		it('body with tool references', async () => {
		...
		it('header with argumentHint', async () => {
		...
		it('agents with .md extension (no .agent.md)', async () => {
	...
	describe('listPromptFiles - extensions', () => {

		it('Contributed prompt file', async () => {
