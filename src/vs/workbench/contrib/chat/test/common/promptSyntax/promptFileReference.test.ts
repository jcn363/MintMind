...
describe('PromptFileReference', function () {
	...
	it('resolves nested file references', async function () {
	...
	describe('metadata', () => {
		...
		describe('applyTo', () => {
			it('prompt language', async function () {
				const rootFolderName = 'resolves-nested-file-references';
				const rootFolder = `/${rootFolderName}`;
				const rootUri = toUri(rootFolder);
			...
			it('instructions language', async function () {
				const rootFolderName = 'resolves-nested-file-references';
				const rootFolder = `/${rootFolderName}`;
				const rootUri = toUri(rootFolder);
		...
		describe('tools and agent compatibility', () => {
			it('ask agent', async function () {
				const rootFolderName = 'resolves-nested-file-references';
				const rootFolder = `/${rootFolderName}`;
				const rootUri = toUri(rootFolder);
