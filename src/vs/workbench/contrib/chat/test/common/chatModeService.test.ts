...
describe('ChatModeService', () => {
	...
	it('should return builtin modes', () => {
	...
	it('should adjust builtin modes based on tools agent availability', () => {
		// With tools agent
	...
	it('should find builtin modes by id', () => {
	...
	it('should handle custom modes from prompts service', async () => {
	...
	it('should fire change event when custom modes are updated', async () => {
	...
	it('should find custom modes by id', async () => {
		const customMode: ICustomAgent = {
	...
	it('should update existing custom mode instances when data changes', async () => {
	...
	it('should remove custom modes that no longer exist', async () => {
