...
describe('ChatModel', () => {
	...
	it('adoptRequest', async function () {
	...
	it('addCompleteRequest', async function () {
...
describe('Response', () => {
	...
	it('not mergeable markdown', async () => {
		const response = store.add(new Response([]));
	...
	it('consolidated edit summary', async () => {
		const response = store.add(new Response([]));
	...
	it('no edit summary when no edits', async () => {
		const response = store.add(new Response([]));
	...
	it('consolidated edit summary with clear operation', async () => {
		const response = store.add(new Response([]));
...
describe('normalizeSerializableChatData', () => {
