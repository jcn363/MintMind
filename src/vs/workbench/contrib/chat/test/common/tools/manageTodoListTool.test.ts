...
describe('ManageTodoListTool Description Field Setting', () => {
	...
	it('createManageTodoListToolData should include description field when enabled', () => {
	...
	it('createManageTodoListToolData should exclude description field when disabled', () => {
	...
	it('createManageTodoListToolData should use default value for includeDescription', () => {
