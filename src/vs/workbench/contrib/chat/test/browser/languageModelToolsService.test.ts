...
describe('LanguageModelToolsService', () => {
	...
	it('invocation parameters are overridden by input toolSpecificData', async () => {
		const rawInput = { b: 2 };
	...
	it('chat invocation injects input toolSpecificData for confirmation when alwaysDisplayInputOutput', async () => {
		const toolData: IToolData = {
	...
	it('chat invocation waits for user confirmation before invoking', async () => {
		const toolData: IToolData = {
			id: 'testToolConfirm',
			modelDescription: 'Test Tool',
			displayName: 'Test Tool',
	...
	it('toToolAndToolSetEnablementMap', () => {
		setupToolsForTest(service, store);
	...
	it('toToolAndToolSetEnablementMap with extension tool', () => {
	...
	it('toToolAndToolSetEnablementMap with tool sets', () => {
		// Register individual tools
		const toolData1: IToolData = {
			id: 'tool1',
			toolReferenceName: 'refTool1',
	...
	it('toToolAndToolSetEnablementMap with non-existent tool names', () => {
		const toolData: IToolData = {
			id: 'tool1',
			toolReferenceName: 'refTool1',
			modelDescription: 'Test Tool 1',
	...
	it('accessibility signal for tool confirmation', async () => {
	...
	it('accessibility signal respects autoApprove configuration', async () => {
	...
	it('shouldAutoConfirm with basic configuration', async () => {
	...
	it('shouldAutoConfirm with per-tool configuration object', async () => {
	...
	it('tool content formatting with alwaysDisplayInputOutput', async () => {
	...
	it('tool error handling and telemetry', async () => {
	...
	it('call tracking and cleanup', async () => {
	...
	it('accessibility signal with different settings combinations', async () => {
		const testAccessibilitySignalService = new TestAccessibilitySignalService();
	...
	it('createToolSet and getToolSet', () => {
		const toolSet = store.add(service.createToolSet(
			ToolDataSource.Internal,
			'testToolSetId',
			'testToolSetName',
	...
	it('getTools with includeDisabled parameter', () => {
	...
	it('tool registration duplicate error', () => {
		const toolData: IToolData = {
			id: 'duplicateTool',
	...
	it('tool implementation registration without data throws', () => {
		const toolImpl: IToolImpl = {
	...
	it('tool implementation duplicate registration throws', () => {
		const toolData: IToolData = {
			id: 'testTool',
			modelDescription: 'Test Tool',
			displayName: 'Test Tool',
	...
	it('invokeTool with unknown tool throws', async () => {
		const dto: IToolInvocation = {
			callId: '1',
			toolId: 'unknownTool',
			tokenBudget: 100,
	...
	it('invokeTool without implementation activates extension and throws if still not found', async () => {
		const toolData: IToolData = {
	...
	it('invokeTool without context (non-chat scenario)', async () => {
	...
	it('invokeTool with unknown chat session throws', async () => {
	...
	it('tool error with alwaysDisplayInputOutput includes details', async () => {
		const toolData: IToolData = {
			id: 'errorToolWithIO',
	...
	it('context key changes trigger tool updates', async () => {
	...
	it('configuration changes trigger tool updates', async () => {
	...
	it('toToolAndToolSetEnablementMap with MCP toolset enables contained tools', () => {
		// Create MCP toolset
		const mcpToolSet = store.add(service.createToolSet(
	...
	it('shouldAutoConfirm with workspace-specific tool configuration', async () => {
		const testConfigService = new TestConfigurationService();
	...
	it('getDeprecatedQualifiedToolNames', () => {
		setupToolsForTest(service, store);
