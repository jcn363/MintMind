...
describe('PromptValidator', () => {
	...
	describe('agents', () => {
		...
		it('agent with errors (empty description, unknown tool & model)', async () => {
			const content = [
			/* 01 */'---',
		...
		it('each tool must be string', async () => {
			const content = [
				'---',
				'description: "Test"',
				`tools: ['tool1', 2]`,
		...
		it('unknown attribute in agent file', async () => {
			const content = [
				'---',
				'description: "Test"',
		...
		it('tools with invalid handoffs', async () => {
			{
				const content = [
					'---',
					'description: "Test"',
		...
		it('agent with handoffs attribute', async () => {
			const content = [
				'---',
		...
		it('github-copilot agent with supported attributes', async () => {
			const content = [
				'---',
		...
		it('github-copilot agent warns about model and handoffs attributes', async () => {
			const content = [
				'---',
				'name: "GitHubAgent"',
				'description: "GitHub Copilot agent"',
		...
		it('github-copilot agent does not validate variable references', async () => {
			const content = [
				'---',
				'name: "GitHubAgent"',
				'description: "GitHub Copilot agent"',
		...
		it('github-copilot agent rejects unsupported attributes', async () => {
			const content = [
				'---',
				'name: "GitHubAgent"',
				'description: "GitHub Copilot agent"',
		...
		it('default target (no target specified) validates as vscode', async () => {
			const content = [
				'---',
		...
		it('name attribute validation', async () => {
			// Valid name
			{
				const content = [
					'---',
		...
		it('github-copilot target requires name attribute', async () => {
	...
	describe('instructions', () => {
		...
		it('instructions invalid applyTo type', async () => {
			const content = [
				'---',
				'description: "Instr"',
				'applyTo: 5',
		...
		it('instructions invalid applyTo glob & unknown attribute', async () => {
			const content = [
				'---',
				'description: "Instr"',
		...
		it('invalid header structure (YAML array)', async () => {
			const content = [
				'---',
				'- item1',
				'---',
		...
		it('name attribute validation in instructions', async () => {
			// Valid name
			{
				const content = [
					'---',
	...
	describe('prompts', () => {
		...
		it('prompt valid with agent mode (default) and tools and a BYO model', async () => {
		...
		it('prompt model not suited for agent mode', async () => {
		...
		it('prompt with custom agent BeastMode and tools', async () => {
		...
		it('prompt with custom mode BeastMode and tools', async () => {
		...
		it('prompt with custom mode an agent', async () => {
			// Explicit custom mode should be recognized; BeastMode kind comes from setup; ensure tools accepted
			const content = [
				'---',
				'description: "Prompt custom mode"',
		...
		it('prompt with unknown agent Ask', async () => {
			const content = [
				'---',
		...
		it('prompt with agent edit', async () => {
			const content = [
				'---',
		...
		it('name attribute validation in prompts', async () => {
			// Valid name
			{
				const content = [
					'---',
	...
	describe('body', () => {
		it('body with existing file references and known tools has no markers', async () => {
			const content = [
				'---',
				'description: "Refs"',
				'---',
		...
		it('body with missing file references reports warnings', async () => {
			const content = [
				'---',
		...
		it('body with unknown tool variable reference warns', async () => {
			const content = [
				'---',
		...
		it('body with tool not present in tools list', async () => {
			const content = [
				'---',
				'tools: []',
				'---',
