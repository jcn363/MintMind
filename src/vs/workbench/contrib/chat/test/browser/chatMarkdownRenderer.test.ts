...
describe('ChatMarkdownRenderer', () => {
	...
	it('supportHtml with one-line markdown', async () => {
	...
	it('invalid HTML with attributes', async () => {
...
<pre><code>code here</code></pre>`);
	...
	it('mixed valid and invalid HTML', async () => {
		const md = new MarkdownString(`
<h1>heading</h1>
<details>
<ul>
...
<pre><canvas>canvas here</canvas></pre><details></details>`);
	...
	it('self-closing elements', async () => {
		{
	...
	it('remote images are disallowed', async () => {
