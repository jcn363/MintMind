...
describe('ChatEditingCheckpointTimeline', function () {
	...
	it('creates initial checkpoint on construction', function () {
	...
	it('canUndo and canRedo are initially false', function () {
		assert.strictEqual(timeline.canUndo.get(), false);
		assert.strictEqual(timeline.canRedo.get(), false);
	});

	it('createCheckpoint increments epoch and creates checkpoint', function () {
	...
	it('createCheckpoint does not create duplicate checkpoints', function () {
		timeline.createCheckpoint('req1', 'stop1', 'Checkpoint 1');
	...
	it('incrementEpoch increases epoch counter', function () {
		const initialEpoch = timeline.getStateForPersistence().epochCounter;
	...
	it('recordFileBaseline stores baseline', function () {
	...
	it('recordFileOperation stores operation', function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('basic undo/redo with text edits', async function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('file creation and deletion operations', async function () {
	...
	it('file rename operations', async function () {
	...
	it('multiple sequential edits to same file', async function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('getCheckpointIdForRequest returns correct checkpoint', function () {
	...
	it('getCheckpointIdForRequest returns undefined for non-existent checkpoint', function () {
		const checkpoint = timeline.getCheckpointIdForRequest('nonexistent', 'stop1');
		assert.strictEqual(checkpoint, undefined);
	});

	it('requestDisablement tracks disabled requests', async function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('persistence - save and restore state', function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('navigating between multiple requests', async function () {
	...
	it('getContentURIAtStop returns snapshot URI', function () {
	...
	it('undoing entire request when appropriate', async function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('operations use incrementing epochs', function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('navigateToCheckpoint throws error for invalid checkpoint ID', async function () {
	...
	it('navigateToCheckpoint does nothing when already at target epoch', async function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('recording operation after undo truncates future history', async function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('redo after recording new operation should work', async function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('redo when there is no checkpoint after operation', async function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('getContentAtStop returns empty for non-existent file', async function () {
	...
	it('getContentAtStop with epoch-based stopId', async function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('hasFileBaseline correctly reports baseline existence', function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('multiple text edits to same file are properly replayed', async function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('checkpoint with same requestId and undoStopId is not duplicated', function () {
	...
	it('finding baseline after file rename operation', async function () {
		const oldUri = URI.parse('file:///old.txt');
		const newUri = URI.parse('file:///new.txt');
	...
	it('baseline lookup across different request IDs', async function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('getContentAtStop with file that does not exist in operations', async function () {
		const uri = URI.parse('file:///test.txt');
	...
	it('undoToLastCheckpoint when canUndo is false does nothing', async function () {
	...
	it('redoToNextCheckpoint when canRedo is false does nothing', async function () {
	...
	it('orphaned operations and checkpoints are removed after undo and new changes', async function () {
		const uri = URI.parse('file:///test.txt');
