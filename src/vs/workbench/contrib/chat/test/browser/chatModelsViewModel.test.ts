...
describe('ChatModelsViewModel', () => {
	...
	it('should fetch all models without filters', () => {
	...
	it('should filter by provider display name', () => {
	...
	it('should filter by multiple providers with OR logic', () => {
	...
	it('should filter by single capability - tools', () => {
	...
	it('should filter by single capability - vision', () => {
	...
	it('should filter by single capability - agent', () => {
	...
	it('should filter by multiple capabilities with AND logic', () => {
	...
	it('should filter by three capabilities with AND logic', () => {
	...
	it('should return no results when filtering by incompatible capabilities', () => {
	...
	it('should filter by visibility - visible:true', () => {
	...
	it('should filter by visibility - visible:false', () => {
	...
	it('should combine provider, capability, and visibility filters', () => {
	...
	it('should filter by text matching model name', () => {
	...
	it('should filter by text matching vendor name', () => {
	...
	it('should combine text search with capability filter', () => {
	...
	it('should handle search value with only whitespace', () => {
		const results = viewModel.fetch('   ');
	...
	it('should match capability text in free text search', () => {
	...
	it('should toggle vendor collapsed state', () => {
	...
	it('should fire onDidChangeModelEntries when entitlement changes', async () => {
		let fired = false;
	...
	it('should handle quoted search strings', () => {
	...
	it('should remove filter keywords from text search', () => {
	...
	it('should support toolcalling alias for tools capability', () => {
	...
	it('should support agentmode alias for agent capability', () => {
	...
	it('should include matched capabilities in results', () => {
		const results = viewModel.fetch('@capability:tools @capability:vision');
	...
	it('should not show vendor header when only one vendor exists', async () => {
	...
	it('should show vendor headers when multiple vendors exist', () => {
	...
	it('should show models even when single vendor is collapsed', async () => {
	...
	it('should filter single vendor models by capability', async () => {
		const { viewModel: singleVendorViewModel } = createSingleVendorViewModel(store, chatEntitlementService);
		await singleVendorViewModel.resolve();
	...
	it('should always place copilot vendor at the top', () => {
		const results = viewModel.fetch('');
	...
	it('should maintain copilot at top with multiple vendors', async () => {
	...
	it('should keep copilot at top even with text search', () => {
	...
	it('should keep copilot at top when filtering by capability', () => {
		const results = viewModel.fetch('@capability:tools');
