...
describe('ChatTodoListWidget Accessibility', () => {
	...
	it('creates proper semantic list structure', () => {
	...
	it('todo items have proper accessibility attributes', () => {
		widget.render(testSessionUri);
	...
	it('status icons are hidden from screen readers', () => {
		widget.render(testSessionUri);
	...
	it('todo items have complete aria-label with status information', () => {
		widget.render(testSessionUri);
	...
	it('widget displays properly when no todos exist', () => {
	...
	it('title element displays progress correctly and is accessible', () => {
		widget.render(testSessionUri);
