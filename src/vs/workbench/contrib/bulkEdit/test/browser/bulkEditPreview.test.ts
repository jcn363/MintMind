...
describe('BulkEditPreview', function () {
	...
	it('one needsConfirmation unchecks all of file', async function () {
	...
	it('has categories', async function () {
	...
	it('has not categories', async function () {
	...
	it('category selection', async function () {
	...
	it('fix bad metadata', async function () {
