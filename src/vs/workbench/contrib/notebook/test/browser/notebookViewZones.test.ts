...
describe('NotebookRangeMap with top padding', () => {
...
describe('NotebookRangeMap with whitesspaces', () => {
	...
	it('Whitespace CRUD', async function () {
	...
	it('Whitespace with editing', async function () {
	...
	it('Multiple Whitespaces', async function () {
		await withTestNotebook(
			[
				['# header a', 'markdown', CellKind.Markup, [], {}],
				['var b = 1;', 'javascript', CellKind.Code, [], {}],
	...
	it('Multiple Whitespaces 2', async function () {
		await withTestNotebook(
			[
				['# header a', 'markdown', CellKind.Markup, [], {}],
				['var b = 1;', 'javascript', CellKind.Code, [], {}],
	...
	it('Multiple Whitespaces 3', async function () {
		await withTestNotebook(
			[
				['# header a', 'markdown', CellKind.Markup, [], {}],
				['var b = 1;', 'javascript', CellKind.Code, [], {}],
	...
	// it('Multiple Whitespaces 4', async function () {
	// 	await withTestNotebook(
	// 		[
	// 			['# header a', 'markdown', CellKind.Markup, [], {}],
	// 			['var b = 1;', 'javascript', CellKind.Code, [], {}],
	...
	it('Whitespace with folding support', async function () {
		await withTestNotebook(
			[
				['# header a', 'markdown', CellKind.Markup, [], {}],
				['var b = 1;', 'javascript', CellKind.Code, [], {}],
	...
	it('Whitespace with multiple viewzones at same position', async function () {
		await withTestNotebook(
			[
				['# header a', 'markdown', CellKind.Markup, [], {}],
				['var b = 1;', 'javascript', CellKind.Code, [], {}],
