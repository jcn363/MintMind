...
describe('NotebookViewModel Decorations', () => {
	...
	it('tracking range', async function () {
		await withTestNotebook(
			[
				['var a = 1;', 'javascript', CellKind.Code, [], {}],
				['var b = 2;', 'javascript', CellKind.Code, [], {}],
	...
	it('tracking range 2', async function () {
		await withTestNotebook(
			[
				['var a = 1;', 'javascript', CellKind.Code, [], {}],
				['var b = 2;', 'javascript', CellKind.Code, [], {}],
	...
	it('diff hidden ranges', async function () {
...
describe('NotebookViewModel API', () => {
	...
	it('#115432, get nearest code cell', async function () {
		await withTestNotebook(
			[
	...
	it('#108464, get nearest code cell', async function () {
		await withTestNotebook(
			[
				['# header a', 'markdown', CellKind.Markup, [], {}],
				['var b = 1;', 'javascript', CellKind.Code, [], {}],
