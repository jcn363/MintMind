...
describe('NotebookDiff Diff Service', () => {
	...
	it('diff different source', async () => {
		const { mapping, diff } = await mapCells([
			[['x'], 'javascript', CellKind.Code, [{ outputId: 'someOtherId', outputs: [{ mime: Mimes.text, data: VSBuffer.wrap(new Uint8Array([3])) }] }], { metadata: { collapsed: false }, executionOrder: 3 }],
		], [
	...
	it('diff different source (2 cells)', async () => {
		const { mapping, diff } = await mapCells([
			[['x'], 'javascript', CellKind.Code, [{ outputId: 'someOtherId', outputs: [{ mime: Mimes.text, data: VSBuffer.wrap(new Uint8Array([3])) }] }], { metadata: { collapsed: false }, executionOrder: 3 }],
			[['y'], 'javascript', CellKind.Code, [{ outputId: 'someOtherId', outputs: [{ mime: Mimes.text, data: VSBuffer.wrap(new Uint8Array([3])) }] }], { metadata: { collapsed: false }, executionOrder: 3 }],
		], [
	...
	it('diff different source (first cell changed)', async () => {
		const { mapping, diff } = await mapCells([
	...
	it('diff test small source', async () => {
		const { mapping, diff } = await mapCells([
	...
	it('diff test data single cell', async () => {
		const { mapping, diff } = await mapCells([
			[[
	...
	it('diff foo/foe (swapped cells)', async () => {
		const { mapping, diff } = await mapCells([
	...
	it('diff foo/foe (swapped cells with changes in output)', async () => {
		const { mapping, diff } = await mapCells([
			[['def foe(x, y):\n', '    return x + y\n', 'foe(3, 2)'], 'javascript', CellKind.Code, [{ outputId: 'someId', outputs: [{ mime: Mimes.text, data: VSBuffer.wrap(new Uint8Array([6])) }] }], { metadata: { collapsed: false }, executionOrder: 5 }],
			[['def foo(x, y):\n', '    return x * y\n', 'foo(1, 2)'], 'javascript', CellKind.Code, [{ outputId: 'someId', outputs: [{ mime: Mimes.text, data: VSBuffer.wrap(new Uint8Array([2])) }] }], { metadata: { collapsed: false }, executionOrder: 6 }],
			[[''], 'javascript', CellKind.Code, [], {}]
	...
	it('diff insert 1 at the top', async () => {
		const { mapping, diff } = await mapCells([
	...
	it('diff insert 1 at the top with lots of cells', async () => {
	...
	it('diff insert 3 at the top with lots of cells', async () => {
	...
	it('diff insert 1 in the middle', async () => {
	...
	it('LCS (swap cells with outputs)', async () => {
		const { mapping, diff } = await mapCells([
	...
	it('Swap cells with output and with same code in each cell', async () => {
		const { mapping, diff } = await mapCells([
			[['# Description'], 'markdown', CellKind.Markup, [], { metadata: {} }],
			[['x = 3'], 'javascript', CellKind.Code, [], { metadata: { collapsed: true }, executionOrder: 1 }],
			[['x'], 'javascript', CellKind.Code, [{ outputId: 'someId', outputs: [{ mime: Mimes.text, data: VSBuffer.wrap(new Uint8Array([3])) }] }], { metadata: { collapsed: false }, executionOrder: 1 }],
	...
	it('Change outputs of cells', async () => {
		const { mapping, diff } = await mapCells([
			[['# Description'], 'markdown', CellKind.Markup, [], { metadata: {} }],
			[['x = 3'], 'javascript', CellKind.Code, [], { metadata: { collapsed: true }, executionOrder: 1 }],
			[['x'], 'javascript', CellKind.Code, [{ outputId: 'someId', outputs: [{ mime: Mimes.text, data: VSBuffer.wrap(new Uint8Array([3])) }] }], { metadata: { collapsed: false }, executionOrder: 1 }],
	...
	it('diff output fast check', async () => {
		const { mapping, diff } = await mapCells([
			[['x'], 'javascript', CellKind.Code, [{ outputId: 'someOtherId', outputs: [{ mime: Mimes.text, data: VSBuffer.wrap(new Uint8Array([3])) }] }], { metadata: { collapsed: false }, executionOrder: 3 }],
			[['y'], 'javascript', CellKind.Code, [{ outputId: 'someOtherId', outputs: [{ mime: Mimes.text, data: VSBuffer.wrap(new Uint8Array([4])) }] }], { metadata: { collapsed: false }, executionOrder: 3 }],
		], [
	...
	it('No cells and add 1 cell', async () => {
		const { mapping, diff } = await mapCells([
		], [
	...
	it('One cells and delete 1 cell', async () => {
		const { mapping, diff } = await mapCells([
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined]
		], [
		]);
	...
	it('No changes with 1 cell', async () => {
		const { mapping, diff } = await mapCells([
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined]
		], [
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined]
	...
	it('One changes with 1 cell', async () => {
		const { mapping, diff } = await mapCells([
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined]
		],
			[
	...
	it('No changes with 2 cells', async () => {
		const { mapping, diff } = await mapCells([
	...
	it('One changes with 2 cells, 1st cell changed', async () => {
		const { mapping, diff } = await mapCells([
			[['# Hello World'], 'markdown', CellKind.Markup, [], undefined],
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined]
		], [
	...
	it('2 cells, 1st cell deleted', async () => {
		const { mapping, diff } = await mapCells([
			[['# Hello World'], 'markdown', CellKind.Markup, [], undefined],
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined]
		], [
	...
	it('2 cells, inserted a cell in the middle', async () => {
		const { mapping, diff } = await mapCells([
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined],
			[['print("Foo Bar")'], 'python', CellKind.Code, [], undefined]
		], [
	...
	it('One changes with 2 cells, 2nd cell changed', async () => {
		const { mapping, diff } = await mapCells([
			[['# Hello World'], 'markdown', CellKind.Markup, [], undefined],
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined]
		], [
	...
	it('Two cells, all cells changed', async () => {
		const { mapping, diff } = await mapCells([
			[['# Hello World'], 'markdown', CellKind.Markup, [], undefined],
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined]
		]
	...
	it('Insert a md cell and modify the next code cell (few cells)', async () => {
		const { mapping, diff } = await mapCells([
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined],
			[['print("foo bar")'], 'python', CellKind.Code, [], undefined],
		]
	...
	it('Insert a md cell and modify the next code cell', async () => {
		const { mapping, diff } = await mapCells([
			[['# Hello World'], 'markdown', CellKind.Markup, [], undefined],
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined],
			[['# Foo Bar'], 'markdown', CellKind.Markup, [], undefined],
	...
	it('Delete code cell and insert MD cell, both will not match', async () => {
		const { mapping, diff } = await mapCells([
			[['# Hello World'], 'markdown', CellKind.Markup, [], undefined],
	...
	it('Delete MD cell and insert code cell, both will not match', async () => {
		const { mapping, diff } = await mapCells([
			[['# Hello World'], 'markdown', CellKind.Markup, [], undefined],
			[['import sys'], 'python', CellKind.Code, [], undefined],
			[['sys.executable'], 'python', CellKind.Code, [], undefined],
	...
	it('Insert a md cell and modify the next 2 code cells', async () => {
		const { mapping, diff } = await mapCells([
			[['# Hello World'], 'markdown', CellKind.Markup, [], undefined],
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined],
			[['# Foo Bar'], 'markdown', CellKind.Markup, [], undefined],
	...
	it('Insert a md cell, delete a cell and modify the next 2 code cells', async () => {
		const { mapping, diff } = await mapCells([
			[['# Hello World'], 'markdown', CellKind.Markup, [], undefined],
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined],
			[['# Foo Bar'], 'markdown', CellKind.Markup, [], undefined],
	...
	it('Insert a md cell, delete a code cell and modify the next 2 code cells (deleted and inserted lineup)', async () => {
		const { mapping, diff } = await mapCells([
			[['# Hello World'], 'markdown', CellKind.Markup, [], undefined],
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined],
			[['import sys'], 'python', CellKind.Code, [], undefined],
	...
	it('Insert a few md cells and modify the next few code cells', async () => {
		const { mapping, diff } = await mapCells([
			[['# Hello World'], 'markdown', CellKind.Markup, [], undefined],
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined],
			[['# Foo Bar'], 'markdown', CellKind.Markup, [], undefined],
	...
	it('Insert & delete a few md cells and modify the next few code cells', async () => {
		const { mapping, diff } = await mapCells([
			[['# Hello World'], 'markdown', CellKind.Markup, [], undefined],
			[['print("Hello world")'], 'python', CellKind.Code, [], undefined],
			[['# Foo Bar'], 'markdown', CellKind.Markup, [], undefined],
	...
	it('Detect modification and insertion of cells', async () => {
		const { mapping, diff } = await mapCells(
			[
				{
					'cell_type': 'markdown',
	...
	it('Detect modification in 2 cells', async () => {
		const { mapping, diff } = await mapCells(
			[
				{
					'cell_type': 'markdown',
	...
	it('Detect modification in multiple cells', async () => {
		const { mapping, diff } = await mapCells(
			[
				{
					'cell_type': 'markdown',
	...
	it('Modification with Insertion, detected as deletion of a cell', async () => {
		const { mapping, diff } = await mapCells(
			[
				{
					'cell_type': 'markdown',
	...
	it('Modification of three cells', async () => {
		const { mapping, diff } = await mapCells(
			[
				{
					'cell_type': 'markdown',
	...
	it('Modification of multiple cells', async () => {
		const { mapping, diff } = await mapCells(
			[
				{
					'cell_type': 'markdown',
	...
	it('Modification of a large cell and insert a new cell', async () => {
		const { mapping, diff } = await mapCells(
			[
				{
					'cell_type': 'markdown',
	...
	it('Misalignment due to 2 deleted cells', async () => {
		const { mapping, diff } = await mapCells(
			[
				{
					'cell_type': 'markdown',
	...
	it('Insert a few cells (one on top), modify a few and completely misaligned', async () => {
		const { mapping, diff } = await mapCells(
			[
				{
					'cell_type': 'code',
