...
describe('NotebookDiff EditorHeightCalculator', () => {
	['Hide Unchanged Regions', 'Show Unchanged Regions'].forEach(suiteTitle => {
		describe(suiteTitle, () => {
			...
			it('1 original line with change in same line', async () => {
			...
			it('1 original line with insertion of a new line', async () => {
				originalModel = disposables.add(createTextModel(['Hello World']));
			...
			it('1 line with update to a line and insert of a new line', async () => {
				originalModel = disposables.add(createTextModel(['Hello World']));
			...
			it('10 line with update to a line and insert of a new line', async () => {
			...
			it('50 lines with updates, deletions and inserts', async () => {
