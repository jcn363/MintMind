...
describe('notebookCellDiagnostics', () => {
	...
	it('diagnostic is added for cell execution failure', async function () {
	...
	it('diagnostics are cleared only for cell with new execution', async function () {
		await withTestNotebook([
			['print(x)', 'python', CellKind.Code, [], {}],
