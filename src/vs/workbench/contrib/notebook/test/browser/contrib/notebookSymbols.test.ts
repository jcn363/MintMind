...
describe('Notebook Symbols', function () {
	...
	it('Cell without symbols cache', function () {
	...
	it('Cell with simple symbols', async function () {
	...
	it('Cell with nested symbols', async function () {
	...
	it('Multiple Cells with symbols', async function () {
