...
describe('Cell Output Clipboard Tests', () => {
	...
	it('Copy text/plain output', async () => {
	...
	it('Nothing copied for invalid mimetype', async () => {
		const clipboard = new ClipboardService();
	...
	it('Text copied if available instead of invalid mime type', async () => {
		const clipboard = new ClipboardService();
	...
	it('Selected mimetype is preferred', async () => {
		const clipboard = new ClipboardService();
	...
	it('copy subsequent output', async () => {
		const clipboard = new ClipboardService();
	...
	it('adjacent stream outputs are concanented', async () => {
		const clipboard = new ClipboardService();
	...
	it('error output uses the value in the stack', async () => {
		const clipboard = new ClipboardService();
	...
	it('error without stack uses the name and message', async () => {
		const clipboard = new ClipboardService();
