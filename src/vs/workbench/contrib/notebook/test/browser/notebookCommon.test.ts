...
describe('NotebookCommon', () => {
	...
	it('sortMimeTypes default orders', function () {
	...
	it('sortMimeTypes user orders', function () {
	...
	it('sortMimeTypes glob', function () {
		assert.deepStrictEqual(
			new MimeTypeDisplayOrder([
...
describe('CellUri', function () {
	...
	it('parse, generate (file-scheme)', function () {
	...
	it('parse, generate (foo-scheme)', function () {
...
describe('CellRange', function () {
	...
	it('Cell range to index', function () {
	...
	it('Cell index to range', function () {
	...
	it('Reduce ranges 2, empty ranges', function () {
...
describe('NotebookWorkingCopyTypeIdentifier', function () {
	...
	it('supports notebook type only', function () {
	...
	it('supports different viewtype', function () {
