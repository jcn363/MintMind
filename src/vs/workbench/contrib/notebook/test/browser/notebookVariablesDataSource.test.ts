...
describe('NotebookVariableDataSource', () => {
	...
	it('Get children for large list', async () => {
	...
	it('Get children for very large list', async () => {
	...
	it('Cancel while enumerating through children', async () => {
