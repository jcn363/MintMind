...
describe('NotebookKernelService', () => {
	...
	it('notebook priorities', function () {
	...
	it('new kernel with higher affinity wins, https://github.com/microsoft/vscode/issues/122028', function () {
	...
	it('onDidChangeSelectedNotebooks not fired on initial notebook open #121904', function () {
	...
	it('onDidChangeSelectedNotebooks not fired on initial notebook open #121904, p2', async function () {
