...
describe('NotebookCellAnchor', () => {
	...
	it('Basic anchoring', async function () {
	...
	it('Anchor during execution until user scrolls up', async function () {
		const listView = new MockListView() as unknown as IListView<CodeCellViewModel>;
	...
	it('Only anchor during when the focused cell will be pushed out of view', async function () {
