...
describe('IssueReporter', () => {
	...
	it('sets defaults to include all data', () => {
	...
	it('serializes model skeleton when no data is provided', () => {
		const issueReporterModel = new IssueReporterModel({});
...
<!-- generated by issue reporter -->`);
	...
	it('serializes GPU information when data is provided', () => {
		const issueReporterModel = new IssueReporterModel({
			issueType: 0,
			systemInfo: {
				os: 'Darwin',
...
<!-- generated by issue reporter -->`);
	...
	it('serializes experiment info when data is provided', () => {
		const issueReporterModel = new IssueReporterModel({
			issueType: 0,
			systemInfo: {
				os: 'Darwin',
...
<!-- generated by issue reporter -->`);
	...
	it('serializes Linux environment information when data is provided', () => {
		const issueReporterModel = new IssueReporterModel({
			issueType: 0,
			systemInfo: {
				os: 'Darwin',
...
<!-- generated by issue reporter -->`);
	...
	it('serializes remote information when data is provided', () => {
		const issueReporterModel = new IssueReporterModel({
			issueType: 0,
			systemInfo: {
				os: 'Darwin',
...
<!-- generated by issue reporter -->`);
	...
	it('escapes backslashes in processArgs', () => {
		const issueReporterModel = new IssueReporterModel({
			issueType: 0,
			systemInfo: {
				os: 'Darwin',
...
<!-- generated by issue reporter -->`);
	...
	it('should supply mode if applicable', () => {
		const issueReporterModel = new IssueReporterModel({
			isUnsupported: true,
			restrictedMode: true
		});
...
<!-- generated by issue reporter -->`);
	...
	it('should have support for filing on extensions for bugs, performance issues, and feature requests', () => {
		[
			IssueType.Bug,
