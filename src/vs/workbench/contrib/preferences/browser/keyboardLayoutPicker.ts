...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in MintMind in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open MintMind and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
