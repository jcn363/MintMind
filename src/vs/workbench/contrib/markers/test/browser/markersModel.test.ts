...
describe('MarkersModel Test', () => {
	...
	it('marker ids are unique', function () {
	...
	it('sort palces resources with no errors at the end', function () {
	...
	it('sort resources by file path', function () {
	...
	it('sort markers by severity, line and column', function () {
	...
	it('Markers for same-document but different fragment', function () {
	...
	it('Problems are no sorted correctly #99135', function () {
