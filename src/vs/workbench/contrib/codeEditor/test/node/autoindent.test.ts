...
describe('Auto-Reindentation - TypeScript/JavaScript', () => {
	...
	it.skip('Find Cases of Incorrect Indentation with the Reindent Lines Command', () => {
	...
	it('Issue #209859: do not do reindentation for tokens inside of a string', () => {
	...
	it.skip('Incorrect deindentation after `*/}` string', () => {
	...
	it.skip('Issue 43244: incorrect indentation when signature of function call spans several lines', () => {
