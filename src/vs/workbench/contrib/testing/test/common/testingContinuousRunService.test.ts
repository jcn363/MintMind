...
describe('TestingContinuousRunService', () => {
	...
	describe('lifecycle', () => {
		...
		it('stops profiles in DFS order', () => {
			cr.start([profile1], 'a\0b\0c\0d');
			cr.start([profile1], 'a\0b');
			cr.start([profile1], 'a\0b\0c');
		...
		it('updates profile for a test if profile is changed', () => {
		...
		it('stops a single profile test', () => {
