...
export class MintMindWorkspace extends ObservableWorkspace implements IDisposable {
	...
	constructor(
		...
		const documents = mapObservableArrayCached(this, models, (m, store) => {
			...
			return store.add(new MintMindndDocument(m));
...
export class MintMindndDocument extends Disposable implements IObservableDocument {
