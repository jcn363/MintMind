...
describe('Markdown Setting Renderer Test', () => {
	...
	it('render code setting button with value', () => {
	...
	it('actions with value + updating and restoring', async () => {
