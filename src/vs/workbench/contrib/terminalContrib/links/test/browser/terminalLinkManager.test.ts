...
describe('TerminalLinkManager', () => {
	...
	describe('registerExternalLinkProvider', () => {
		it('should not leak disposables if the link manager is already disposed', () => {
	...
	describe('getLinks and open recent link', () => {
		it('should return no links', async () => {
		...
		it('should return word links in order', async () => {
			const link1 = {
				range: {
		...
		it('should return web links in order', async () => {
			const link1 = {
		...
		it('should return file links in order', async () => {
			const link1 = {
