...
describe('Workbench - TerminalUriLinkDetector', () => {
	...
	for (const c of linkComputerCases) {
		it('link computer case: `' + c[1] + '`', async () => {
	...
	it('should detect file:// links with :line suffix', async () => {
	...
	it('should detect file:// links with :line:col suffix', async () => {
		validResources = [URI.file('c:/folder/file')];
	...
	it('should filter out https:// link that exceed 4096 characters', async () => {
	...
	it('should filter out file:// links that exceed 4096 characters', async () => {
		// 8 + 200 * 10 = 2008 characters
