...
describe('Terminal Mouse Wheel Zoom', () => {
	ensureNoDisposablesAreLeakedInTestSuite();

	it('clamps font size to minimum value when below bounds', () => {
	...
	it('clamps font size to maximum value when above bounds', () => {
	...
	it('preserves font size when within bounds', () => {
	...
	it('clamps font size when going below minimum', () => {
	...
	it('clamps font size when going above maximum', () => {
