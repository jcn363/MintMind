...
import { ILanguageModelToolsService, ToolDataSource, MintMindToolReference } from '../../../chat/common/languageModelToolsService.js';
...
class ChatAgentToolsContribution extends Disposable implements IWorkbenchContribution {
	...
	constructor(
		...
		const runCommandsToolSet = this._register(toolsService.createToolSet(ToolDataSource.Internal, 'runCommands', MintMindndToolReference.runCommands, {
