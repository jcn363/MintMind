...
describe('CommandLineAutoApprover', () => {
	...
	describe('autoApprove with allow patterns only', () => {
		...
		it('should handle multiple commands in autoApprove', () => {
			setAutoApprove({
				'echo': true,
				'ls': true,
				'pwd': true
	...
	describe('autoApprove with deny patterns only', () => {
		it('should deny commands in autoApprove', () => {
			setAutoApprove({
				'rm': false,
				'del': false
			});
		...
		it('should not auto-approve safe commands when no allow patterns are present', () => {
			setAutoApprove({
				'rm': false
			});
	...
	describe('autoApprove with mixed allow and deny patterns', () => {
		it('should deny commands set to false even if other commands are set to true', () => {
			setAutoApprove({
				'echo': true,
				'rm': false
			});
		...
		it('should auto-approve allow patterns not set to false', () => {
			setAutoApprove({
				'echo': true,
				'ls': true,
				'pwd': true,
	...
	describe('regex patterns', () => {
		...
		it('should handle regex patterns in autoApprove', () => {
			setAutoApprove({
				'/^echo/': true,
				'/^ls/': true,
				'pwd': true
		...
		it('should handle regex patterns for deny', () => {
			setAutoApprove({
				'echo': true,
				'rm': true,
				'/^rm\\s+/': false,
		...
		describe('flags', () => {
			it('should handle case-insensitive regex patterns with i flag', () => {
				setAutoApprove({
					'/^echo/i': true,
					'/^ls/i': true,
					'/rm|del/i': false
			...
			it('should handle multiple regex flags', () => {
				setAutoApprove({
					'/^git\\s+/gim': true,
					'/dangerous/gim': false
				});
			...
			it('should handle various regex flags', () => {
				setAutoApprove({
			...
			it('should handle regex patterns without flags', () => {
				setAutoApprove({
					'/^echo/': true,
					'/rm|del/': false
				});
	...
	describe('edge cases', () => {
		...
		it('should ignore the empty string key', () => {
			setAutoApprove({
				'': true
			});
		...
		it('should handle empty regex patterns that could cause endless loops', () => {
			setAutoApprove({
				'//': true,
				'/(?:)/': true,
		...
		it('should handle regex patterns that would cause endless loops', () => {
			setAutoApprove({
				'/a*/': true,
				'/b?/': true,
				'/(x|)*/': true,
		...
		it('should handle mixed valid and problematic regex patterns', () => {
			setAutoApprove({
	...
	describe('path-aware auto approval', () => {
		it('should handle path variations with forward slashes', () => {
			setAutoApprove({
				'bin/foo': true
			});
		...
		it('should handle path variations with backslashes', () => {
			setAutoApprove({
				'bin\\script.bat': true
			});
		...
		it('should not treat non-paths as paths', () => {
			setAutoApprove({
		...
		it('should handle paths with mixed separators in config', () => {
			setAutoApprove({
		...
		it('should work with command line auto approval for paths', () => {
	...
	describe('PowerShell-specific commands', () => {
		...
		it('should be case-insensitive for PowerShell commands', () => {
			setAutoApprove({
				'Get-ChildItem': true,
				'Get-Content': true,
				'Remove-Item': false
		...
		it('should be case-insensitive for PowerShell aliases', () => {
			setAutoApprove({
				'ls': true,
				'dir': true,
				'rm': false,
		...
		it('should be case-insensitive with regex patterns', () => {
			setAutoApprove({
				'/^Get-/': true,
		...
		it('should handle case-insensitive PowerShell commands on different OS', () => {
			setAutoApprove({
				'Get-Process': true,
				'Stop-Process': false
			});
	...
	describe('isCommandLineAutoApproved - matchCommandLine functionality', () => {
		it('should auto-approve command line patterns with matchCommandLine: true', () => {
			setAutoApproveWithCommandLine({
		...
		it('should not auto-approve regular patterns with isCommandLineAutoApproved', () => {
			setAutoApprove({
				'echo': true
			});
		...
		it('should handle regex patterns with matchCommandLine: true', () => {
			setAutoApproveWithCommandLine({
		...
		it('should handle case-insensitive regex with matchCommandLine: true', () => {
			setAutoApproveWithCommandLine({
		...
		it('should handle complex command line patterns', () => {
			setAutoApproveWithCommandLine({
		...
		it('should return false for empty command line', () => {
			setAutoApproveWithCommandLine({
				'echo': { approve: true, matchCommandLine: true }
			});
		...
		it('should handle mixed configuration with matchCommandLine entries', () => {
			setAutoApproveWithCommandLine({
		...
		it('should handle deny patterns with matchCommandLine: true', () => {
			setAutoApproveWithCommandLine({
				'echo': { approve: true, matchCommandLine: true },
		...
		it('should prioritize deny list over allow list for command line patterns', () => {
			setAutoApproveWithCommandLine({
				'/echo/': { approve: true, matchCommandLine: true },
		...
		it('should handle complex deny patterns with matchCommandLine', () => {
			setAutoApproveWithCommandLine({
		...
		it('should handle empty regex patterns with matchCommandLine that could cause endless loops', () => {
			setAutoApproveWithCommandLine({
		...
		it('should handle regex patterns with matchCommandLine that would cause endless loops', () => {
			setAutoApproveWithCommandLine({
		...
		it('should handle mixed valid and problematic regex patterns with matchCommandLine', () => {
			setAutoApproveWithCommandLine({
		...
		it('should handle invalid regex patterns with matchCommandLine gracefully', () => {
			setAutoApproveWithCommandLine({
	...
	describe('isDefaultRule logic', () => {
		...
		it('should correctly identify default rules vs user-defined rules', () => {
		...
		it('should mark as default when command is only in default config but not in user config', () => {
			setAutoApproveWithDefaults(
		...
		it('should handle default rules with different values', () => {
			setAutoApproveWithDefaults(
				{ 'echo': true, 'rm': true },
				{ 'echo': false, 'rm': true }
			);
		...
		it('should handle regex patterns as default rules', () => {
			setAutoApproveWithDefaults(
				{ '/^git/': true, '/^npm/': false },
		...
		it('should handle command line rules with isDefaultRule', () => {
		...
		it('should handle command line rules with different matchCommandLine values', () => {
			setAutoApproveWithDefaultsCommandLine(
				{
					'echo': { approve: true, matchCommandLine: true },
		...
		it('should handle boolean vs object format consistency', () => {
			setAutoApproveWithDefaultsCommandLine(
				{
					'echo': true,
		...
		it('should return undefined for noMatch cases', () => {
			setAutoApproveWithDefaults(
				{ 'echo': true },
				{ 'cat': true }
			);
		...
		it('should handle only default config with no user overrides', () => {
			setAutoApproveWithDefaults(
				{},
				{ 'echo': true, 'ls': false }
			);
		...
		it('should handle complex nested object rules', () => {
			setAutoApproveWithDefaultsCommandLine(
				{
					'npm': { approve: true, matchCommandLine: true },
		...
		it('should handle PowerShell case-insensitive matching with defaults', () => {
			shell = 'pwsh';
		...
		it('should use structural equality for object comparison', () => {
	...
	describe('ignoreDefaultAutoApproveRules', () => {
		function setAutoApproveWithDefaults(userConfig: { [key: string]: boolean }, defaultConfig: { [key: string]: boolean }) {
			// Set up mock configuration with default values
			configurationService.setUserConfiguration(TerminalChatAgentToolsSettingId.AutoApprove, userConfig);
		...
		it('should include default rules when ignoreDefaultAutoApproveRules is false (default behavior)', () => {
			setAutoApproveWithDefaults(
				{ 'ls': true },
				{ 'echo': true, 'cat': true }
			);
		...
		it('should exclude default rules when ignoreDefaultAutoApproveRules is true', () => {
			setAutoApproveWithDefaults(
				{ 'ls': true },
				{ 'echo': true, 'cat': true }
			);
