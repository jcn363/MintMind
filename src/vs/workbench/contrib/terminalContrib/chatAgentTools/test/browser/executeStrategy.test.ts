...
describe('Execute Strategy - Prompt Detection', () => {
	ensureNoDisposablesAreLeakedInTestSuite();

	it('detectsCommonPromptPattern should detect PowerShell prompts', () => {
	...
	it('detectsCommonPromptPattern should detect Command Prompt', () => {
...
user@host:~$ `;
	...
	it('detectsCommonPromptPattern should reject non-prompt content', () => {
	...
	it('detectsCommonPromptPattern should handle edge cases', () => {
	...
	describe('detectsInputRequiredPattern', () => {
		it('detects yes/no confirmation prompts (pairs and variants)', () => {
		...
		it('detects PowerShell multi-option confirmation line', () => {
			strictEqual(
