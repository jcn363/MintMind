...
describe('TerminalCompletionService', () => {
	...
	describe('resolveResources should return undefined', () => {
		it('if neither showFiles nor showFolders are true', async () => {
	...
	describe('resolveResources should return folder completions', () => {
		beforeEach(() => {
			validResources = [URI.parse('file:///test')];
			childResources = [
		...
		it('./| should return folder completions', async () => {
			const resourceOptions: TerminalCompletionResourceOptions = {
				cwd: URI.parse('file:///test'),
				showDirectories: true,
				pathSeparator
		...
		it('cd ./| should return folder completions', async () => {
			const resourceOptions: TerminalCompletionResourceOptions = {
				cwd: URI.parse('file:///test'),
				showDirectories: true,
				pathSeparator
		...
		it('cd ./f| should return folder completions', async () => {
			const resourceOptions: TerminalCompletionResourceOptions = {
				cwd: URI.parse('file:///test'),
				showDirectories: true,
				pathSeparator
	...
	describe('resolveResources should handle file and folder completion requests correctly', () => {
		beforeEach(() => {
			validResources = [URI.parse('file:///test')];
			childResources = [
		...
		it('./| should handle hidden files and folders', async () => {
			const resourceOptions: TerminalCompletionResourceOptions = {
				cwd: URI.parse('file:///test'),
				showDirectories: true,
				showFiles: true,
		...
		it('./h| should handle hidden files and folders', async () => {
			const resourceOptions: TerminalCompletionResourceOptions = {
				cwd: URI.parse('file:///test'),
				showDirectories: true,
				showFiles: true,
	...
	describe('~ -> $HOME', () => {
		...
		it('~| should return completion for ~', async () => {
		...
		it('~/| should return folder completions relative to $HOME', async () => {
		...
		it('~/vscode/| should return folder completions relative to $HOME/vscode', async () => {
	...
	describe('resolveResources edge cases and advanced scenarios', () => {
		beforeEach(() => {
			validResources = [];
			childResources = [];
		});
		...
		if (isWindows) {
			it('C:/Foo/| absolute paths on Windows', async () => {
				const resourceOptions: TerminalCompletionResourceOptions = {
			...
			it('c:/foo/| case insensitivity on Windows', async () => {
				const resourceOptions: TerminalCompletionResourceOptions = {
					cwd: URI.parse('file:///c:'),
					showDirectories: true,
					pathSeparator
			...
			it('/foo/| absolute paths NOT on Windows', async () => {
				const resourceOptions: TerminalCompletionResourceOptions = {
					cwd: URI.parse('file:///'),
					showDirectories: true,
					pathSeparator
		...
		if (isWindows) {
			it('.\\folder | Case insensitivity should resolve correctly on Windows', async () => {
				const resourceOptions: TerminalCompletionResourceOptions = {
			...
			it('./folder | Case sensitivity should resolve correctly on Mac/Unix', async () => {
				const resourceOptions: TerminalCompletionResourceOptions = {
					cwd: URI.parse('file:///test'),
					showDirectories: true,
					pathSeparator: '/'
		...
		it('| Empty input should resolve to current directory', async () => {
			const resourceOptions: TerminalCompletionResourceOptions = {
				cwd: URI.parse('file:///test'),
				showDirectories: true,
				pathSeparator
		...
		it('should ignore environment variable setting prefixes', async () => {
			const resourceOptions: TerminalCompletionResourceOptions = {
				cwd: URI.parse('file:///test'),
				showDirectories: true,
				pathSeparator
		...
		it('./| should handle large directories with many results gracefully', async () => {
			const resourceOptions: TerminalCompletionResourceOptions = {
				cwd: URI.parse('file:///test'),
				showDirectories: true,
				pathSeparator
		...
		it('./folder| should include current folder with trailing / is missing', async () => {
			const resourceOptions: TerminalCompletionResourceOptions = {
				cwd: URI.parse('file:///test'),
				showDirectories: true,
				pathSeparator
		...
		it('test/| should normalize current and parent folders', async () => {
			const resourceOptions: TerminalCompletionResourceOptions = {
				cwd: URI.parse('file:///test'),
				showDirectories: true,
				pathSeparator
	...
	describe('cdpath', () => {
		...
		it('cd | should show paths from $CDPATH (relative)', async () => {
		...
		it('cd | should show paths from $CDPATH (absolute)', async () => {
		...
		it('cd | should support pulling from multiple paths in $CDPATH', async () => {
			configurationService.setUserConfiguration('terminal.integrated.suggest.cdPath', 'relative');
	...
	if (isWindows) {
		describe('gitbash', () => {
			it('should convert Git Bash absolute path to Windows absolute path', () => {
			...
			it('should convert Windows absolute path to Git Bash absolute path', () => {
			...
			it('resolveResources with c:/ style absolute path for Git Bash', async () => {
				const resourceOptions: TerminalCompletionResourceOptions = {
			...
			it('resolveResources with cwd as Windows path (relative)', async () => {
				const resourceOptions: TerminalCompletionResourceOptions = {
					cwd: URI.file('C:\\Users\\foo'),
					showDirectories: true,
					showFiles: true,
			...
			it('resolveResources with cwd as Windows path (absolute)', async () => {
				const resourceOptions: TerminalCompletionResourceOptions = {
					cwd: URI.file('C:\\Users\\foo'),
					showDirectories: true,
					showFiles: true,
	...
	if (!isWindows) {
		describe('symlink support', () => {
			it('should include symlink target information in completions', async () => {
				const resourceOptions: TerminalCompletionResourceOptions = {
					cwd: URI.parse('file:///test'),
					pathSeparator,
					showFiles: true,
	...
	describe('completion label escaping', () => {
		it('| should escape special characters in file/folder names for POSIX shells', async () => {
			const resourceOptions: TerminalCompletionResourceOptions = {
				cwd: URI.parse('file:///test'),
				showDirectories: true,
				showFiles: true,
	...
	describe('Provider Configuration', () => {
		...
		it('should enable providers by default when no configuration exists', () => {
		...
		it('should disable providers when explicitly set to false', () => {
		...
		it('should enable providers when explicitly set to true', () => {
			const provider1 = createMockProvider('provider1');
			const provider2 = createMockProvider('provider2');
			const providers = [provider1, provider2];
		...
		it('should handle mixed configuration correctly', () => {
			const provider1 = createMockProvider('provider1');
			const provider2 = createMockProvider('provider2');
