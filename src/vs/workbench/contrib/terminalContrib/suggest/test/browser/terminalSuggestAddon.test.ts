...
describe('Terminal Suggest Addon - Inline Completion, Shell Type Support', () => {
	ensureNoDisposablesAreLeakedInTestSuite();

	it('should return true for supported shell types', () => {
	...
	it('should return false for unsupported shell types', () => {
