...
describe('Terminal Suggest Dynamic Configuration', () => {
	ensureNoDisposablesAreLeakedInTestSuite();

	it('should update configuration when providers change', () => {
		// Test initial state
	...
	it('should include default providers even when none provided', () => {
