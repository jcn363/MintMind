...
describe('Debug - StreamDebugAdapter', () => {
	...
	it(`StreamDebugAdapter (NamedPipeDebugAdapter) can initialize a connection`, async () => {
	...
	it(`StreamDebugAdapter (SocketDebugAdapter) can initialize a connection`, async () => {
