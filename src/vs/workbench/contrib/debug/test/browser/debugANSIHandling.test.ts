...
describe('Debug - ANSI Handling', () => {
	...
	it('appendStylizedStringToContainer', () => {
	...
	it('Expected single sequence operation', () => {
	...
	it('Expected single 8-bit color sequence operation', () => {
	...
	it('Expected single 24-bit color sequence operation', () => {
	...
	it('Expected multiple sequence operation', () => {
	...
	it('Invalid codes treated as regular text', () => {
