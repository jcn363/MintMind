...
describe('Debug - Link Detector', () => {
	...
	it('relativeLinkWithWorkspace', async () => {
		const input = '\./foo/bar.js';
	...
	it('singleLineLinkAndText', function () {
		...
		assert(expectedOutput.it(output.outerHTML));
	...
	it('highlightOverlappingLinkStart', () => {
		const input = isWindows ? 'C:\\foo\\bar.js:12:34' : '/Users/foo/bar.js:12:34';
	...
	it('highlightOverlappingLinkEnd', () => {
		const input = isWindows ? 'C:\\foo\\bar.js:12:34' : '/Users/foo/bar.js:12:34';
	...
	it('highlightOverlappingLinkStartAndEnd', () => {
		const input = isWindows ? 'C:\\foo\\bar.js:12:34' : '/Users/foo/bar.js:12:34';
