...
describe('Debug - CallStack', () => {
	...
	it('threads multiple with allThreadsStopped', async () => {
		const threadId1 = 1;
	...
	it('allThreadsStopped in multiple events', async () => {
		const threadId1 = 1;
		const threadName1 = 'firstThread';
		const threadId2 = 2;
		const threadName2 = 'secondThread';
	...
	it('threads multiple without allThreadsStopped', async () => {
	...
	it('stack frame get specific source name', () => {
		const session = createTestSession(model);
		disposables.add(session);
		model.addSession(session);
	...
	it('debug child sessions are added in correct order', () => {
	...
	it('focusStackFrameThreadAndSession', () => {
		const threadId1 = 1;
		const threadName1 = 'firstThread';
		const threadId2 = 2;
		const threadName2 = 'secondThread';
