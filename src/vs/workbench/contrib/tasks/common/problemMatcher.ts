...
export namespace Config {
	...
	*/
	export interface ProblemMatcher {
		...
		/**
		 * The owner of the produced MintMind problem. This is typically
		 * the identifier of a MintMindnd language service if the problems are
		...
		*/
		...
		/**
		* The severity of the MintMindnd problem produced by this problem matcher.
		*
		* Valid values are:
