...
describe('DecorationsService', function () {
	...
	it('Async provider, async/evented result', function () {
	...
	it('Sync provider, sync result', function () {
	...
	it('Clear decorations on provider dispose', async function () {
		return runWithFakedTimers({}, async function () {
	...
	it('No default bubbling', function () {
	...
	it('Decorations not showing up for second root folder #48502', async function () {
	...
	it('Decorations not bubbling... #48745', function () {
	...
	it('Folder decorations don\'t go away when file with problems is deleted #61919 (part1)', function () {
	...
	it('Folder decorations don\'t go away when file with problems is deleted #61919 (part2)', function () {
	...
	it('FileDecorationProvider intermittently fails #133210', async function () {
