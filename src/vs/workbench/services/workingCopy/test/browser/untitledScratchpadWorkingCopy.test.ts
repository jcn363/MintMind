...
describe('UntitledScratchpadWorkingCopy', () => {
	...
	it('modified - cleared when content event signals isEmpty', async () => {
	...
	it('modified - not cleared when content event signals isEmpty when associated resource', async () => {
		workingCopy.dispose();
	...
	it('resolve - without contents', async () => {
	...
	it('backup - with initial contents uses those even if unresolved', async () => {
		workingCopy.dispose();
