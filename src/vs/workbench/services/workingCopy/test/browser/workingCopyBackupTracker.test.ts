...
describe('WorkingCopyBackupTracker (browser)', function () {
	...
	it('Track backups (untitled)', function () {
		return untitledBackupTest();
	});

	it('Track backups (untitled with initial contents)', function () {
		return untitledBackupTest({ resource: undefined, contents: 'Foo Bar' });
	});

	it('Track backups (custom)', async function () {
	...
	it('Restore backups (basics, some handled)', async function () {
	...
	it('Restore backups (basics, none handled)', async function () {
		const [tracker, accessor] = await restoreBackupsInit();
	...
	it('Restore backups (basics, error case)', async function () {
	...
	it('Restore backups (multiple handlers)', async function () {
		const [tracker, accessor] = await restoreBackupsInit();
	...
	it('Restore backups (editors already opened)', async function () {
		const [tracker, accessor] = await restoreBackupsInit();
