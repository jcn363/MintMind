...
describe('Parsing .gitignore files', () => {
	...
	it('paths with trailing slashes do not match files', () => {
	...
	it('parsing simple gitignore files', () => {
		let i = 'node_modules\nout\n';
	...
	it('parsing files-in-folder exclude', () => {
		let i = 'node_modules/*\n';
	...
	it('real world example: vscode-js-debug', () => {
		const i = `.cache/
			.profile/
			.cdp-profile/
			.headless-profile/
	...
	it('various advanced constructs found in popular repos', () => {
	...
	it('case-insensitive ignore files', () => {
