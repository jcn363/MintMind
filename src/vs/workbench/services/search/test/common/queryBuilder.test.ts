...
describe('QueryBuilderCommon', () => {
	...
	it('resolveResourcesForSearchIncludes passes through paths without special glob characters', () => {
	...
	it('resolveResourcesForSearchIncludes escapes paths with special characters', () => {
	...
	it('escapeGlobPattern properly escapes square brackets for literal matching', () => {
