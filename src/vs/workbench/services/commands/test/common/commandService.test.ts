...
describe('CommandService', function () {
	...
	it('fwd activation error', async function () {
	...
	it('!onReady, but executeCommand', function () {
	...
	it('issue #34913: !onReady, unknown command', function () {
	...
	it('Stop waiting for * extensions to activate when trigger is satisfied #62457', function () {
	...
	it('issue #71471: wait for onCommand activation even if a command is registered', () => {
	...
	it('issue #142155: execute commands synchronously if possible', async () => {
		const actualOrder: string[] = [];
