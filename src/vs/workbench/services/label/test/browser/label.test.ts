...
describe('URI Label', () => {
	...
	it('mulitple authority', function () {
		labelService.registerFormatter({
			scheme: 'vscode',
	...
	it('custom query without value', function () {
		labelService.registerFormatter({
			scheme: 'vscode',
			formatting: {
				label: 'LABEL${query.prefix}: ${query.path}/END',
	...
	it('custom query without query json', function () {
		labelService.registerFormatter({
			scheme: 'vscode',
			formatting: {
				label: 'LABEL${query.prefix}: ${query.path}/END',
	...
	it('custom query without query', function () {
		labelService.registerFormatter({
			scheme: 'vscode',
			formatting: {
				label: 'LABEL${query.prefix}: ${query.path}/END',
...
describe('multi-root workspace', () => {
	...
	it('labels of files in multiroot workspaces are the foldername followed by offset from the folder', () => {
		labelService.registerFormatter({
			scheme: 'file',
			formatting: {
	...
	it('labels with context after path', () => {
		labelService.registerFormatter({
			scheme: 'file',
			formatting: {
				label: '${path} (${scheme})',
	...
	it('relative label without formatter', () => {
...
describe('workspace at FSP root', () => {
	...
	it('relative label with explicit path separator', () => {
