...
describe('Preferences Validation', () => {
	...
	it('exclusive max and max work together properly', () => {
		{
	...
	it('exclusive min and min work together properly', () => {
		{
	...
	it('multiple of works for both integers and fractions', () => {
		{
	...
	it('integer type correctly adds a validation', () => {
		{
	...
	it('null is allowed only when expected', () => {
		{
	...
	it('custom error messages are shown', () => {
