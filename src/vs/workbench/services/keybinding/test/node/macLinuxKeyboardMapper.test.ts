...
describe('keyboardMapper - MAC de_ch', () => {
	...
	it('resolveKeyboardEvent Cmd+[KeyY]', () => {
	...
	it('resolveKeyboardEvent Cmd+[BracketRight]', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
	...
	it('resolveKeybinding Cmd+Shift+/', () => {
		_assertResolveKeybinding(
	...
	it('resolveKeybinding Cmd+K Cmd+\\', () => {
		_assertResolveKeybinding(
	...
	it('resolveKeybinding Cmd+DownArrow', () => {
		_assertResolveKeybinding(
	...
	it('resolveKeybinding Cmd+NUMPAD_0', () => {
		_assertResolveKeybinding(
	...
	it('resolveKeybinding Ctrl+Home', () => {
		_assertResolveKeybinding(
	...
	it('resolveKeyboardEvent Ctrl+[Home]', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
	...
	it('resolveUserBinding Cmd+[Comma] Cmd+/', () => {
	...
	it('resolveKeyboardEvent Single Modifier MetaLeft+', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
	...
	it('resolveKeyboardEvent Single Modifier MetaRight+', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
...
describe('keyboardMapper - MAC en_us', () => {
	...
	it('resolveKeyboardEvent mapAltGrToCtrlAlt AltGr+Z', async () => {
...
describe('keyboardMapper - LINUX de_ch', () => {
	...
	it('resolveKeyboardEvent Ctrl+[KeyY]', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
	...
	it('resolveKeyboardEvent Ctrl+[BracketRight]', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
	...
	it('resolveKeybinding Ctrl+Shift+/', () => {
		_assertResolveKeybinding(
			KeyMod.CtrlCmd | KeyMod.Shift | KeyCode.Slash,
			[{
				label: 'Ctrl+Shift+\'',
	...
	it('resolveKeybinding Ctrl+K Ctrl+\\', () => {
		_assertResolveKeybinding(
			KeyChord(KeyMod.CtrlCmd | KeyCode.KeyK, KeyMod.CtrlCmd | KeyCode.Backslash),
			[]
		);
	...
	it('resolveKeybinding Ctrl+DownArrow', () => {
		_assertResolveKeybinding(
			KeyMod.CtrlCmd | KeyCode.DownArrow,
			[{
	...
	it('resolveKeybinding Ctrl+NUMPAD_0', () => {
		_assertResolveKeybinding(
			KeyMod.CtrlCmd | KeyCode.Numpad0,
			[{
				label: 'Ctrl+NumPad0',
	...
	it('resolveKeyboardEvent Ctrl+[KeyX]', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
	...
	it('resolveUserBinding Ctrl+[Comma] Ctrl+/', () => {
		assertResolveKeybinding(
	...
	it('resolveKeyboardEvent Single Modifier ControlLeft+', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
	...
	it('resolveKeyboardEvent Single Modifier ControlRight+', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
...
describe('keyboardMapper - LINUX en_us', () => {
	...
	it('resolveKeyboardEvent Ctrl+[KeyZ]', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
	...
	it('issue #23393: resolveKeybinding Ctrl+Enter', () => {
		_assertResolveKeybinding(
	...
	it('issue #23393: resolveKeyboardEvent Ctrl+[NumpadEnter]', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
	...
	it('resolveUserBinding Ctrl+[Comma]', () => {
		assertResolveKeybinding(
			mapper, new Keybinding([
				new ScanCodeChord(true, false, false, false, ScanCode.Comma)
			]),
	...
	it('resolveKeyboardEvent Single Modifier ShiftLeft+', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
	...
	it('resolveKeyboardEvent Single Modifier ShiftRight+', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
	...
	it('resolveKeyboardEvent Single Modifier AltLeft+', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
	...
	it('resolveKeyboardEvent Single Modifier AltRight+', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
	...
	it('resolveKeyboardEvent Only Modifiers Ctrl+Shift+', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
...
describe('keyboardMapper', () => {
	...
	it('issue #23706: Linux UK layout: Ctrl + Apostrophe also toggles terminal', () => {
	...
	it('issue #24064: NumLock/NumPad keys stopped working in 1.11 on Linux', () => {
	...
	it('issue #24107: Delete, Insert, Home, End, PgUp, PgDn, and arrow keys no longer work editor in 1.11', () => {
		const mapper = new MacLinuxKeyboardMapper(false, {}, false, OperatingSystem.Linux);
...
describe('keyboardMapper - LINUX en_uk', () => {
	...
	it('issue #24522: resolveKeyboardEvent Ctrl+Alt+[Minus]', () => {
		assertResolveKeyboardEvent(
			mapper,
			{
				_standardKeyboardEventBrand: true,
...
describe('keyboardMapper - MAC zh_hant', () => {
	...
	it('issue #28237 resolveKeybinding Cmd+C', () => {
		_assertResolveKeybinding(
