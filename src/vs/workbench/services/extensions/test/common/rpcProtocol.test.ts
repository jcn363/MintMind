...
describe('RPCProtocol', () => {
	...
	it('simple call without result', function (done) {
	...
	it('passing buffer as argument', function (done) {
	...
	it('returning a buffer', function (done) {
		delegate = (a1: number, a2: number) => {
			const b = VSBuffer.alloc(4);
			b.buffer[0] = 1;
			b.buffer[1] = 2;
	...
	it('cancelling a call via CancellationToken before', function (done) {
		delegate = (a1: number, a2: number) => a1 + a2;
	...
	it('passing CancellationToken.None', function (done) {
	...
	it('cancelling a call via CancellationToken quickly', function (done) {
	...
	it('throwing an error', function (done) {
		delegate = (a1: number, a2: number) => {
	...
	it('issue #60450: Converting circular structure to JSON', function (done) {
		delegate = (a1: number, a2: number) => {
	...
	it('issue #72798: null errors are hard to digest', function (done) {
		delegate = (a1: number, a2: number) => {
	...
	it('undefined arguments arrive as null', function () {
	...
	it('issue #81424: SerializeRequest should throw if an argument can not be serialized', () => {
		const badObject = {};
		// eslint-disable-next-line local/code-no-any-casts
	...
	it('SerializableObjectWithBuffers is correctly transfered', function (done) {
