...
describe('Workspace Trust', () => {
	...
	describe('Enablement', () => {
		it('workspace trust enabled', async () => {
		...
		it('workspace trust disabled (user setting)', async () => {
		...
		it('workspace trust disabled (--disable-workspace-trust)', () => {
	...
	describe('Management', () => {
		...
		it('empty workspace - trusted', async () => {
			await configurationService.setUserConfiguration('security', getUserSettings(true, true));
		...
		it('empty workspace - untrusted', async () => {
		...
		it('empty workspace - trusted, open trusted file', async () => {
			await configurationService.setUserConfiguration('security', getUserSettings(true, true));
		...
		it('empty workspace - trusted, open untrusted file', async () => {
			await configurationService.setUserConfiguration('security', getUserSettings(true, true));
