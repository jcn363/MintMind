...
describe('Errors', () => {
	...
	it('Transform Error for Serialization', function () {
	...
	it('Transform Error with Cause for Serialization', function () {
	...
	it('Transform Error from Serialization', function () {
	...
	it('Transform Error with Cause from Serialization', function () {
		const cause = new Error('Cause error');
