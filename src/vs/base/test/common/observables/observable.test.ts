...
describe('observables', () => {
	...
	it('bug: Event.fromObservable always should get events', () => {
	...
	describe('autorun error handling', () => {
		it('immediate throw', () => {
			const log = new Log();
	...
	it('recomputeInitiallyAndOnChange should work when a dependency sets an observable', () => {
		const store = new DisposableStore();
		const log = new Log();
	...
	describe('prevent invalid usage', () => {
		describe('reading outside of compute function', () => {
			it('derived', () => {
				let fn: () => void = () => { };
		...
		it.skip('catches cyclic dependencies', () => {
			const log = new Log();
	...
	describe('disposableStores', () => {
		it('derived with store', () => {
			const log = new Log();
			const observable1 = observableValue('myObservableValue1', 0);
	...
	it('derivedHandleChanges with reportChanges', () => {
		const log = new Log();
