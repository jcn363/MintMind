...
describe('YAML Parser', () => {
	...
	describe('objects', () => {
		...
		it('nested objects with address', () => {
			assertValidParse(
				[
					'person:',
					'  name: John Doe',
		...
		it('properties without space after colon', () => {
			assertValidParse(
				['name:John'],
				{
		...
		it('special characters in values', () => {
	...
	describe('arrays', () => {
		...
		it('inline array with internal comment line', () => {
			assertValidParse(
		...
		it('inline arrays of inline arrays', () => {
			assertValidParse(
				[
					'[',
					'  [ee], [ff, gg]',
		...
		it('object with array containing single object', () => {
			assertValidParse(
				[
					'items:',
					'- name: John',
	...
	describe('complex structures', () => {
		...
		it('inline array mixed primitives', () => {
			assertValidParse(
	...
	describe('edge cases and error handling', () => {
		...
		it('duplicate keys allowed with option', () => {
			assertValidParse(
				[
					'key: 1',
					'key: 2'
		...
		it('unexpected indentation error with recovery', () => {
		...
		it('empty values and inline empty array', () => {
			assertValidParse(
				[
					'empty:',
					'array: []'
		...
		it('empty object with only colons', () => {
		...
		it('deeply nested structure performance', () => {
		...
		it('malformed array with position issues', () => {
		...
		it('self-referential like structure', () => {
		...
		it('whitespace advancement robustness', () => {
		...
		it('missing end quote in string values', () => {
		...
		it('comment in inline array #269078', () => {
