...
describe('Types', () => {
	...
	describe('assertDefined', () => {
		it('should not throw if `value` is defined (bool)', async () => {
			assert.doesNotThrow(function () {
				assertDefined(true, 'Oops something happened.');
			});
		});

		it('should not throw if `value` is defined (number)', async () => {
			assert.doesNotThrow(function () {
				assertDefined(5, 'Oops something happened.');
			});
		});

		it('should not throw if `value` is defined (zero)', async () => {
			assert.doesNotThrow(function () {
				assertDefined(0, 'Oops something happened.');
			});
		});

		it('should not throw if `value` is defined (string)', async () => {
			assert.doesNotThrow(function () {
				assertDefined('some string', 'Oops something happened.');
			});
		});

		it('should not throw if `value` is defined (empty string)', async () => {
			assert.doesNotThrow(function () {
	...
	describe('hasKey', () => {
		it('should return true when object has specified key', () => {
			type A = { a: string };
			type B = { b: number };
		...
		it('should return false when object does not have specified key', () => {
			type A = { a: string };
			type B = { b: number };
			const obj: A | B = { b: 42 };
		...
		it('should work with empty key object', () => {
			type A = { a: string };
			type B = { b: number };
			const obj: A | B = { a: 'test' };
