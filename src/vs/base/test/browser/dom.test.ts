...
describe('dom', () => {
	...
	it('removeClass should consider hyphens', function () {
		const element = document.createElement('div');
	...
	describe('$', () => {
		...
		it('should build nodes with class-name', () => {
			const div = $('div.foo');
			assert(div);
			assert(isHTMLElement(div));
			assert.strictEqual(div.tagName, 'DIV');
		...
		it('should build nodes with attributes', () => {
		...
		it('should build nodes with children', () => {
		...
		it('should build nodes with text children', () => {
	...
	describe('h', () => {
		...
		it('should handle ids and classes', () => {
		...
		it('should implicitly handle ids and classes', () => {
			const divId = h('#myid');
			assert.strictEqual(divId.root.tagName, 'DIV');
			assert.strictEqual(divId.root.id, 'myid');
	...
	it('trackAttributes (unfiltered)', async () => {
	...
	it('trackAttributes (filtered)', async () => {
		return runWithFakedTimers({ useFakeTimers: true }, async () => {
			const elementSource = document.createElement('div');
			const elementTarget = document.createElement('div');
	...
	describe('disposableWindowInterval', () => {
		it('basics', async () => {
			let count = 0;
