...
if (process.env['MINTMIND_DEV']) {
	...
	process.env['MINTMIND_DEV_INJECT_NODE_MODULE_LOOKUP_PATH'] = process.env['MINTMIND_DEV_INJECT_NODE_MODULE_LOOKUP_PATH'] || join(import.meta.dirname, '..', 'remote', 'node_modules');
