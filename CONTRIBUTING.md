...
The VS Code project is distributed across multiple repositories. Try to file the issue against the correct repository. Check the list of [Related Projects](https://github.com/jcn363t/vscode/wiki/Related-Projects) if you aren't sure which repo is correct.
...
* Automatically implement the VS Code [feature request pipeline](https://github.com/jcn363t/vscode/wiki/Issues-Triaging#managing-feature-requests).
